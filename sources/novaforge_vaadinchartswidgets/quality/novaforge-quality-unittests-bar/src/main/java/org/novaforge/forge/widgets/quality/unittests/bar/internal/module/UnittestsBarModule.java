 ...
 */
public class UnittestsBarModule extends AbstractQualityModule
{

  /**
   * Logger component
   */
  private static final Log LOGGER = LogFactory.getLog(UnittestsBarModule.class);
  ...
  public byte[] getIcon()
  {
    ...
    try
    {
      final InputStream resource = this.getClass().getResourceAsStream("/unittests.png");
