 ...
 */
package org.novaforge.forge.widgets.quality.violations.timeline.internal.module;
 ...
 */
public class ViolationsTimelineModule extends AbstractQualityModule
{

  /**
   * Logger component
   */
  private static final Log LOGGER = LogFactory.getLog(ViolationsTimelineModule.class);
  ...
  {
    return "qualityviolationstimeline";
  }
  ...
  public byte[] getIcon()
  {
    ...
    try
    {
      final InputStream resource = this.getClass().getResourceAsStream("/violations.png");
