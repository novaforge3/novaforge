 ...
 */
package org.novaforge.forge.widgets.bugtracker.issues.timeline.internal.module;
...
import org.novaforge.forge.widgets.bugtracker.issues.timeline.internal.client.admin.AdminPresenter;
import org.novaforge.forge.widgets.bugtracker.issues.timeline.internal.client.admin.AdminViewImpl;
...
public class AdminComponent extends AbstractWidgetComponent implements WidgetAdminComponent
{
  ...
  {
    return PropertiesFactory.buildProperties(adminPresenter.getVersion(), adminPresenter.getRangeType(),
        adminPresenter.getStartDate(), adminPresenter.getEndDate());
  }
