 ...
 */
public class IssuesTimelineModule extends AbstractWidgetModule
{

  /**
   * Logger component
   */
  private static final Log LOGGER = LogFactory.getLog(IssuesTimelineModule.class);
  ...
  {
    return "bugtrackerissuestimeline";
  }
  ...
  public byte[] getIcon()
  {
    ...
    try
    {
      final InputStream resource = this.getClass().getResourceAsStream("/bugtrackerissuestimeline.png");
