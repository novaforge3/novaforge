...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-alfresco</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-alfresco</feature>")
