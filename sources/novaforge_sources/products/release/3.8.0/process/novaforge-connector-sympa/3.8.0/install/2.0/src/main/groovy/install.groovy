...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-sympa</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-sympa</feature>")
