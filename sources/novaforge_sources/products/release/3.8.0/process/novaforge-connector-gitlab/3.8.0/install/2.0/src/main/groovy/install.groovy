...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-gitlab</feature>"
def gitlabFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-gitlab</feature>")
if (StringUtils.isNotBlank(gitlabFeature)) {
  beaverEngine.replaceElement(deployFile, gitlabFeature, newFeature)
} else {
