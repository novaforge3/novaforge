...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-spip</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-spip</feature>")
