...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-phpbb</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-phpbb</feature>")
