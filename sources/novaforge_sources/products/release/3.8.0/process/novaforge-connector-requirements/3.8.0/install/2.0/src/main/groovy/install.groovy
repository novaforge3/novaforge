...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-requirements-manager</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-requirements-manager</feature>")
