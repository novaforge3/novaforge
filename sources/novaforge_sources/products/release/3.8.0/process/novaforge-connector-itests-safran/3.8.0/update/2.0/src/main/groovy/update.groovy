...
updateFeatureVersion(deployFile, beaverEngine, "novaforge-command-test-distribution-zonal-local")
updateFeatureVersion(deployFile, beaverEngine, "novaforge-command-test-distribution-central")
