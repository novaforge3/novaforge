...
def mantisCfg = pluginsRepository + "novaforge-mantis-std-cfg/" + dataVersion + "/novaforge-mantis-std-cfg-" + dataVersion + "-plugins.cfg"
...
beaverEngine.copyToFile(mantisCfg, pluginConf + "/plugins.mantis.std.cfg")

// Configure Mantis datasource
def mantisDatasource = pluginsRepository + "novaforge-mantis-std-impl/" + dataVersion + "/novaforge-mantis-std-impl-" + dataVersion + "-datasource.cfg"
...
beaverEngine.copyToFile(mantisDatasource, datasourceConf + "/datasource.mantisstd.cfg")