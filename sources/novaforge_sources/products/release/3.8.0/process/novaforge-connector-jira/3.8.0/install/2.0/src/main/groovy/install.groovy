...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-jira</feature>"
def jiraFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-jira</feature>")
if (StringUtils.isNotBlank(jiraFeature)) {
  beaverEngine.replaceElement(deployFile, jiraFeature, newFeature)
} else {
