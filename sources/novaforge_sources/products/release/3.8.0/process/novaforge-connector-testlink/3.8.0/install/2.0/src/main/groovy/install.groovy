...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-testlink</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-testlink</feature>")
