...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-mantis-ard</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-mantis-ard</feature>")
