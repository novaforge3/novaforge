...
$config = array();
$config['siteadminemail']     = '@ADMIN_EMAIL@'; // The default email address of the site administrator
$config['siteadminbounce']    = '@ADMIN_EMAIL@'; // The default email address used for error notification of sent messages for the site administrator (Return-Path)
$config['siteadminname']      = '@ADMIN_NAME@';      // The name of the site administrator

$config['emailmethod']        = '@EMAIL_METHOD@';           // The following values can be used:
$config['protocol'] = $config['emailmethod'];
// mail      -  use internal PHP Mailer
// sendmail  -  use Sendmail Mailer
// smtp      -  use SMTP relaying

$config['emailsmtphost']      = '@SMTP_HOST@:@SMTP_PORT@';      // Sets the SMTP host. You can also specify a different port than 25 by using
