...
def defaultAlias = beaverEngine.getResource("novaforge-connector-limesurvey", "defaultAlias")
def toolAlias = beaverEngine.getResource("novaforge-connector-limesurvey", "toolAlias")
...
// Copy and configure HTTPD limesurvey.service local
def limesurveyService = processTmpPath + "/resources/files/apache/local/limesurvey.service"
def httpService = beaverEngine.getResource("httpServiceLocal")
beaverEngine.copyToFile(limesurveyService, httpService)
