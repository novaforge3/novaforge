...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-svn</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-svn</feature>")
