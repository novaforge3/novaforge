...
def mantisCfg = pluginsRepository + "novaforge-mantis-arc-cfg/" + dataVersion + "/novaforge-mantis-arc-cfg-" + dataVersion + "-plugins.cfg"
...
// Copy mantis-arc cfg to novaforge runtime
beaverEngine.copyToFile(mantisCfg, pluginConf + "/plugins.mantis.arc.cfg")

// Configure mantis-arc datasource
def mantisDatasource = pluginsRepository + "novaforge-mantis-arc-impl/" + dataVersion + "/novaforge-mantis-arc-impl-" + dataVersion + "-datasource.cfg"
...
// Copy mantis-arc datasource to novaforge runtime
beaverEngine.copyToFile(mantisDatasource, datasourceConf + "/datasource.mantis.arc.cfg")