...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-log</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-log</feature>")
