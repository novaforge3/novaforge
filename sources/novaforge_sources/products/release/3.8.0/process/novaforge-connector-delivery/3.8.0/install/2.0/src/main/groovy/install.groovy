...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-delivery-manager</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-delivery-manager</feature>")
