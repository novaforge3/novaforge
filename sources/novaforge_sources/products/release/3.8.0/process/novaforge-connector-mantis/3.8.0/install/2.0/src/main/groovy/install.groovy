...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-mantis</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-mantis</feature>")
