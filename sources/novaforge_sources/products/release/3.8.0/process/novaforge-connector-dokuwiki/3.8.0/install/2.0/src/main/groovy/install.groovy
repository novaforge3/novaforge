...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-dokuwiki</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-dokuwiki</feature>")
