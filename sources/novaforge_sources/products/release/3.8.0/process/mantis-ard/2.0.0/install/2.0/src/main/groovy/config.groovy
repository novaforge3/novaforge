...
// local apache service
def localService = processTmpPath + "/resources/apache/local/mantis_ard.service"
def apacheLocalServices = beaverEngine.getResource("httpServiceLocal")
beaverEngine.replaceElement(localService, "@DEFAULT_ALIAS@", mantisArdDefaultAlias)
beaverEngine.replaceElement(localService, "@TOOL_ALIAS@", mantisArdToolAlias)
beaverEngine.replaceElement(localService, "@HOME@", mantisArdHome)
beaverEngine.copyToFile(localService ,apacheLocalServices)
...
//Create database
def sqlCreateTableFile = processTmpPath + "/resources/sql/createTablesMantisARD.sql"
beaverEngine.replaceElement(sqlCreateTableFile, "%DATABASE%", mantisArdDatabase)
