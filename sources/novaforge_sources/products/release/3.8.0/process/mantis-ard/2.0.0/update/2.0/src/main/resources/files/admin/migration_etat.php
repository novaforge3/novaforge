...
function migration_update_configuration ($p_file_name, &$p_result){
    $p_result = array();
	...
	$line = get_line_in_file($t_instance_file, "Custom Configuration Variables for project");
	$t_type = end(explode('_', trim($t_instance_file[$line])));

	
	switch ( $t_type ) {	
		case RISK:

			$t_status_line = get_line_in_file($t_instance_file, "g_fixed_status");
				 
			$t_sentence_status1 = "\t".'$g_default_status_prev' ." = 20;\n";
			$t_sentence_status2 = "\t".'$g_default_status_next' ."  = 90;\n";
			$t_sentence_status2 .= "\t".'$g_default_status_enum_string = \'' . $g_risk_status . "';\n";			
			$t_sentence_status2 .= "\t".'$g_bug_reopen_status' . " = 20;\n";
			$t_sentence_status2 .= "\t".'$g_bug_feedback_status' . "= 20;\n";
			$t_sentence_status2 .= "\t".'$g_bug_resolved_status_threshold' . "= 90;\n";
			$t_sentence_status2 .= "\t".'$g_bug_readonly_status_threshold' . "= 90;\n";
			$t_sentence_status2 .= "\t".'$g_bug_assigned_status' . " = 20;\n";
			
			#workflow
			$t_line_wkf = get_line_in_file($t_instance_file, "#workflow")+1;
			$t_sentence_wkf[0] = "\t".'$g_status_enum_workflow[10]' . "='20:progress';\n";
			$t_sentence_wkf[1] = "\t".'$g_status_enum_workflow[20]' . "='90:closed';\n";
			$t_sentence_wkf[2] = "\t".'$g_status_enum_workflow[90]' . "='20:progress';\n";
		...
		case ACTION:
			...
			$t_sentence_status1 = "\t".'$g_default_status_prev' ." = 20;\n";
			$t_sentence_status2 = "\t".'$g_default_status_next' ."  = 90;\n";
			$t_sentence_status2 .= "\t".'$g_default_status_enum_string = \'' . $g_action_status . "';\n";			
			$t_sentence_status2 .= "\t".'$g_bug_reopen_status' . " = 20;\n";
			$t_sentence_status2 .= "\t".'$g_bug_feedback_status' . "= 20;\n";
			$t_sentence_status2 .= "\t".'$g_bug_resolved_status_threshold' . "= 90;\n";
			$t_sentence_status2 .= "\t".'$g_bug_readonly_status_threshold' . "= 90;\n";
		...
		case DECISION:
			...
			$t_sentence_status1 = "\t".'$g_default_status_prev' ." = 50;\n";
			$t_sentence_status2 = "\t".'$g_default_status_next' ."  = 80;\n";
			$t_sentence_status2 .= "\t".'$g_default_status_enum_string = \'' . $g_decision_status . "';\n";			
			$t_sentence_status2 .= "\t".'$g_bug_reopen_status' . " = 20;\n";
			$t_sentence_status2 .= "\t".'$g_bug_feedback_status' . "= 20;\n";
			$t_sentence_status2 .= "\t".'$g_bug_resolved_status_threshold' . "= 90;\n";
			$t_sentence_status2 .= "\t".'$g_bug_readonly_status_threshold' . "= 90;\n";
			...
			$t_sentence_wkf[0] = "\t".'$g_status_enum_workflow[10]' . "='20:progress,30:to_validate,80:cancel';\n";
			$t_sentence_wkf[1] = "\t".'$g_status_enum_workflow[20]' . "='30:to_validate,80:cancel';\n";
			$t_sentence_wkf[2] = "\t".'$g_status_enum_workflow[30]' . "='40:validate,50:invalidate,80:cancel';\n";
			$t_sentence_wkf[3] = "\t".'$g_status_enum_workflow[40]' . "='20:progress,90:closed';\n";
			$t_sentence_wkf[4] = "\t".'$g_status_enum_workflow[50]' . "='20:progress,90:closed';\n";
			$t_sentence_wkf[5] = "\t".'$g_status_enum_workflow[80]' . "='20:progress,90:closed';\n";
			$t_sentence_wkf[6] = "\t".'$g_status_enum_workflow[90]' . "='20:progress,30:to_validate';\n";
		...
		case EVOLUTION:
			...
			$t_sentence_status1 = "\t".'$g_default_status_prev' ." = 40;\n";
			$t_sentence_status2 = "\t".'$g_default_status_next' ."  = 80;\n";
			$t_sentence_status2 .= "\t".'$g_default_status_enum_string = \'' . $g_evolution_status . "';\n";			
			$t_sentence_status2 .= "\t".'$g_bug_reopen_status' . " = 20;\n";
			$t_sentence_status2 .= "\t".'$g_bug_feedback_status' . "= 20;\n";
			$t_sentence_status2 .= "\t".'$g_bug_resolved_status_threshold' . "= 90;\n";
			$t_sentence_status2 .= "\t".'$g_bug_readonly_status_threshold' . "= 90;\n";
			$t_sentence_status2 .= "\t".'$g_bug_assigned_status' . " = 40;\n";
	...
	if( $t_status_line != false ) {
	    $p_result['migration update configuration'] = 'Mise à jour du fichier de configuration '. $t_type;
		$t_instance_file[$t_status_line] = $t_sentence_status1;	
		$t_status_line = $t_status_line+1;
		$t_instance_file = insert_in_file($t_instance_file, $t_sentence_status2, $t_status_line);
		
		$p_result['migration_update_configuration - status lines'] = 'Status lines OK';
		
		if( $t_line_wkf != false ) {
			foreach ( $t_sentence_wkf as $t_key => $t_value) {
				$t_line_wkf = $t_line_wkf +1;
				$t_instance_file[$t_line_wkf] = $t_value;
			}
			$p_result['migration_update_configuration - workflow lines'] = 'Workflow lines OK';
		}
		
		# --Update File--
		//write_file("conf-instance/config_status_$instance.php", $instance_file);
		write_file(CONF_INSTANCE_FILE_PATH.$p_file_name, $t_instance_file);	
	} else {
	     $p_result['migration update configuration'] = 'Pas de mise à jour du fichier de configuration '. $t_type;
	}
...
function migration_update_classification($p_instance, $p_file_name, $p_status_multi_language, &$p_current_enum_status, &$p_new_enum_status, &$p_update, &$p_result) {
	...
	// Mantis_ARD
	$t_status_languages =  config_get( 'management_language_status');
	...
	// Mantis_ARD
	$current_status_enum_string_line = get_line_in_file($t_instance_file, "g_status_enum_string");
	error_log('PFE $current_status_enum_string_line :'. $current_status_enum_string_line);
	$g_current_enum_status = substr(trim($t_instance_file[$current_status_enum_string_line]),25,-2);
	$t_current_enum_status = MantisEnum::getAssocArrayIndexedByValues($g_current_enum_status );
	$default_status_enum_string_line = get_line_in_file($t_instance_file, "g_default_status_enum_string");
	$g_default_enum_status =  substr(trim($t_instance_file[$default_status_enum_string_line]),33,-2);
	$t_default_enum_status = MantisEnum::getAssocArrayIndexedByValues($g_default_enum_status);
	
	$default_status_prev_line = get_line_in_file($t_instance_file, "g_default_status_prev");
	$t_default_status_prev_ident = substr(trim($t_instance_file[$default_status_prev_line]),25,-1);
	...
	$p_result['default_status_enum_string'] = $g_default_enum_status;
	$p_result['current_status_enum_string'] = $g_current_enum_status;
	...
	foreach ( $t_working_enum_status as $t_current_ident => $t_current_label ) {
		...
		if (in_array($t_current_label, $t_default_enum_status)){
			...
			// MantisARD
			$t_current_ident = MantisEnum::getValue( $g_default_enum_status, $t_current_label);
...
function load_status_languagues () {
	...
	//Mantis_ARD
	$t_default_languages =  config_get( 'management_language_status');
	...
	if (is_dir(CONF_INSTANCE_FILE_PATH)){
		...
		foreach ($t_files as $t_key => $t_file) {
		   if (1 == preg_match("/^config_status_[0-9]+(.{1})php$/", $t_file)){
				...
				<?php
				migration_update_configuration ($t_file, $t_result);
				print_test( $t_result);
