...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-nexus</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-nexus</feature>")
