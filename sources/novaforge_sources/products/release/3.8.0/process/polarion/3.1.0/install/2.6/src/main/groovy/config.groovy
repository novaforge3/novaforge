...
// ************** Configure BaseUrl
def navigationJsp = polarionWarTmp + "/include/navigation.jsp"
beaverEngine.copyToFile(processTmpPath + "/resources/navigation.jsp", navigationJsp)
def baseUrl = beaverEngine.getResource("main","httpd", "baseUrl")
beaverEngine.replaceElement(navigationJsp, "@BASE_URL@", baseUrl)
...
// Add repository to polarion feature
def deployFile = beaverEngine.getResource("deployFile")
beaverEngine.copyToFile(processTmpPath + "/resources/polarion.xml", deployFile)
beaverEngine.replaceElement(deployFile, "@POLARION_DATA_VERSION@", dataVersion)
...
beaverEngine.setOwner(false,localGroup,localUser,deployFile)
