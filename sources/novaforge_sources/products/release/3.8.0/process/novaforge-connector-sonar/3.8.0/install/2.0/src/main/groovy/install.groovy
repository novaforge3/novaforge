...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-sonar</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-sonar</feature>")
