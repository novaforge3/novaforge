...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-svn-agent</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-svn-agent</feature>")
