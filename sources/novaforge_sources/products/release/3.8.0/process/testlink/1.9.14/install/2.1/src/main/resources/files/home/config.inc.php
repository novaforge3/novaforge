 ...
 */
$tlCfg->log_path = '@TESTLINK_LOGS_DIRECTORY@' . DIRECTORY_SEPARATOR ;
 ...
 */
$g_smtp_host        = '@SMTP_HOST@';  # SMTP server MUST BE configured

# Configure using custom_config.inc.php
$g_tl_admin_email     = '@ADMIN_EMAIL@'; # for problem/error notification
$g_from_email         = '@SMTP_NOREPLY@';  # email sender
$g_return_path_email  = 'mantis@@HOSTNAME@';
 ...
 *	'CAS' => use password from CAS server
 */
...
$tlCfg->authentication['cas_server_name'] = '@CAS_HOST@';
$tlCfg->authentication['cas_server_port'] = @CAS_PORT@;
$tlCfg->authentication['cas_server_path'] = '@CAS_URI@';
$tlCfg->authentication['cas_validation_url'] = 'https://@CAS_HOST@:@CAS_PORT@@CAS_VALIDATE_URI@';
 ...
 *
 **/
$g_repositoryPath = '@UPAREA_DIR@';  /* unix example */
