...
# Bug 277 - Delete rights for administrators to update project memberships
...
# ZZZ : due to CAS context, password stored in MD5(SHA1(clear_pwd)) format
INSERT INTO /*prefix*/users (login,password,role_id,email,first,last,locale,active,cookie_string)
			VALUES ('admin','0c7540eb7e65b553ec1ba6b20de79608', 8,'', 'Testlink','Administrator', 'en_GB',1,CONCAT(MD5(RAND()),'0c7540eb7e65b553ec1ba6b20de79608'));
