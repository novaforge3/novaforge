...
CREATE USER '@TESTLINK_USER@'@'@MARIADB_HOST@' IDENTIFIED BY  '@TESTLINK_PWD@';
CREATE DATABASE  `@DATABASE@`;
GRANT ALL PRIVILEGES ON  `@DATABASE@` . * TO  '@TESTLINK_USER@'@'@MARIADB_HOST@' WITH GRANT OPTION ;
...
# ZZZ : prefix length increased from 16 to 50
