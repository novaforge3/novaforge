...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-reference</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-reference</feature>")
