...
def newFeature = "<feature version=\"" + dataVersion + "\">novaforge-plugins-management-module</feature>"
def oldFeature = beaverEngine.getValueFromRegex(deployFile, "<feature version=\"(.*)\">novaforge-plugins-management-module</feature>")
