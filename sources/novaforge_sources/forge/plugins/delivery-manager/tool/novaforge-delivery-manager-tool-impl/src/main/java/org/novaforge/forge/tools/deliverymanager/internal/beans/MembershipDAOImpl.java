...
import org.novaforge.forge.tools.deliverymanager.entity.MembershipEntity;
...
public class MembershipDAOImpl implements MembershipDAO
{
   ...
   */
  @Override
  public Membership newMembership(final User pUser, final Project pProject, final Role pRole)
  {
  ...
  public Membership update(final Membership pMembership)
  {
    ...
    oem.evict(pMembership); // will evict from data cache also
    return pMembership;
  }
