 ...
 * @author falsquelle-e
 */
public interface DeliveryTabView extends IsWidget
{

   /**
    * Get the Tab Panel
    * 
    * @return {@link TabLayoutPanel} the tab panel
    */
    ...
    * 
    * @return {@link Button} the returnbutton
    */
    ...
    * @return
    */
   ValidateDialogBox getReturnValidation();
}
