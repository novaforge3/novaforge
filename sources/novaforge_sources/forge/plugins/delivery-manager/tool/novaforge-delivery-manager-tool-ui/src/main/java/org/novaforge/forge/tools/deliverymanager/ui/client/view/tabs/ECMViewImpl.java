 ...
 * @author caseryj
 */
public class ECMViewImpl extends Composite implements ECMView
{

   private static ECMViewImplUiBinder uiBinder = GWT.create(ECMViewImplUiBinder.class);
   ...
   public ECMViewImpl()
   {
      ...
      this.deliveryTitleLabel.setText(DeliveryCommon.getMessages().ecmTitle());
      ...
      this.nodeUnexistDialogBox = new InfoDialogBox(DeliveryCommon.getMessages()
            .selectedECMNodeHasUnexistingNode(), InfoTypeEnum.WARNING);
      this.saveResultDialogBox = new InfoDialogBox(
            DeliveryCommon.getMessages().saveECMDocumentsSuccessfull(), InfoTypeEnum.SUCCESS, 2500);
   }
   ...
   interface ECMViewImplUiBinder extends UiBinder<Widget, ECMViewImpl>
   {
   }
