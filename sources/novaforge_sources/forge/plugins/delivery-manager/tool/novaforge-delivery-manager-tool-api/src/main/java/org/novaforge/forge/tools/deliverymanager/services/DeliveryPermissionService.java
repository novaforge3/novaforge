 ...
 * @author sbenoist
 */
public interface DeliveryPermissionService
{
  /**
   * This method returns true if the user can edit any form
   * 
   * @param pLogin
   * @param pProjectId
   ...
   */
  boolean canEdit(String pLogin, String pProjectId) throws DeliveryPermissionServiceException;
}
