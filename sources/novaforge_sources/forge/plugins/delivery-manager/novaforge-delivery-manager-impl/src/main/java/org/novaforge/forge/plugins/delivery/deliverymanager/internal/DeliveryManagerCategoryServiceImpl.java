 ...
 * @author rols-p
 */
public class DeliveryManagerCategoryServiceImpl extends AbstractPluginCategoryService implements
    DeliveryCategoryService
{

	private static final String PROPERTY_FILE = "delivery";
