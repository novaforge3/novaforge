...
import org.novaforge.forge.plugins.delivery.deliverymanager.internal.services.domains.DeliveryManagerProxyConfigurationImpl;

/**
 * @author Guillaume Lamirand
 */
public class DeliveryManagerToolInstanceProvider extends DefaultToolInstanceProvider
{
  ...
  {
    return new DeliveryManagerProxyConfigurationImpl(getForgeConfigurationService().getPublicUrl()
