 ...
 */
public class SonarConfigurationServiceImpl implements SonarConfigurationService
{
	...
	/**
	 * Admin URL of sonar instance
	 */
	private String										 adminAccess = "http://127.0.0.1/sonar/settings/index";
