 ...
 * @author lamirang
 */
public class SonarQueues implements PluginQueues
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 7271450102061119180L;
	...
	{
		return SonarQueueName.USER.getQueueName();
	}
	...
	{
		return SonarQueueName.MEMBERSHIP.getQueueName();
	}
	...
	{
		return SonarQueueName.ROLESMAPPING.getQueueName();
	}
