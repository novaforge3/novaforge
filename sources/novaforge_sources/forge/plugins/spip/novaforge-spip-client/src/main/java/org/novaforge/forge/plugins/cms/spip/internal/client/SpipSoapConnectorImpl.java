 ...
 */
public class SpipSoapConnectorImpl implements SpipSoapConnector
{

   private final String                   username;
   private final String                   password;
   private final SpipConnectBindingStub connectBindingStub;
    ...
    */
   public SpipSoapConnectorImpl(String pUsername, String pPassword,
         SpipConnectBindingStub pConnectBindingStub)
   {
      username = pUsername;
      password = pPassword;
    ...
    */
   @Override
   public SpipConnectBindingStub getConnectBindingStub()
   {
