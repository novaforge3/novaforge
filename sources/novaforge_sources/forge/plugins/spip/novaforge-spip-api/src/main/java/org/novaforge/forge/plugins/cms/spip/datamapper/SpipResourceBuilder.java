 ...
 */
package org.novaforge.forge.plugins.cms.spip.datamapper;
 ...
 * @author blachonm
 */
public interface SpipResourceBuilder
{
   SiteInfo buildSiteInfo(final PluginProject pPluginProject, final String pInstanceName);

   SiteInput buildSiteInput(final PluginProject pPluginProject, final String pInstanceName);

   UserData buildUserData(final PluginUser pPluginUser);

   UserInfo buildUserInfo(final PluginUser pPluginUser);
