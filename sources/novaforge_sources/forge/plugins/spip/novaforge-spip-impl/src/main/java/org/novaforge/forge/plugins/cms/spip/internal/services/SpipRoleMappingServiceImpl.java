 ...
 */
public class SpipRoleMappingServiceImpl extends AbstractPluginRolesMappingService implements
    PluginRoleMappingService
{
	...
	{
		return String.valueOf(SpipRolePrivilege.fromLabel(pToolRole).getId());
	}
