 ...
 *
 */
public interface SCMRequirementConnector
{
   /**
    * This method allows to synchronize the requirements referential with a SCM repository
    * 
    * @param pProjectID
    * @throws RequirementConnectorException
    */
   void synchronizeWithCode(String pProjectID, String pCodeRepositoryPath, String pCurrentUser) throws RequirementConnectorException;

   /**
    * This method returns history from synchronization with SCM repository
    * 
    * @param pProjectId
    * @param pBeginDate
    * @param pEndDate
