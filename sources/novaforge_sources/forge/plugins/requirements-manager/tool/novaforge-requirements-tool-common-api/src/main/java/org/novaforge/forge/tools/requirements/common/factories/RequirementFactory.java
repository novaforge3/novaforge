 ...
 */
package org.novaforge.forge.tools.requirements.common.factories;
...
/**
 * Simple factory to abstract the build of a new object used with Requirement tool.
 * 
 * @author Guillaume Morin
 */
public interface RequirementFactory
{
  IRequirement buildNewRequirement();

  IRequirementVersion buildNewRequirementVersion();

  IResourceOOCode buildNewResourceCode();

  ITest buildNewFunctionalTest();

  IProject buildNewProject();

  IRepository buildNewRepository();

  IDirectory buildNewDirectory(EDirectoryLevel pRoot);

  ITask buildNewTask();

  SchedulingConfiguration buildNewSchedulingConfiguration();
