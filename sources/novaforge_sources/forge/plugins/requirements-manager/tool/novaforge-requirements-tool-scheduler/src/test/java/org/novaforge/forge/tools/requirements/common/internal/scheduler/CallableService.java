...
public class CallableService implements CronJobRunnable
{
   ...
   */
  @Override
  public void run(final SchedulingConfiguration pConfig)
  {
    System.out.println("Hello world  " + pConfig.getProjectId());
  }
