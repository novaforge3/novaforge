 ...
 */
package org.novaforge.forge.tools.requirements.common.business.rules;
...
{
   ETestStatus evaluateTestStatus(IRequirement pRequirement) throws BusinessStatusException;

   ECodeStatus evaluateCodeStatus(IRequirement pRequirement) throws BusinessStatusException;
}
