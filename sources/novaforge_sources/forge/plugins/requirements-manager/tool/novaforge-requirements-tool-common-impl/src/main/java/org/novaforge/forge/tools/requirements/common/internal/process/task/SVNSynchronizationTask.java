 ...
 * @author sbenoist
 */
public class SVNSynchronizationTask extends TaskImpl
{
   private final SCMRequirementConnector fSVNConnector;
   private final String fProjectID;
   private final String fCodeRepositoryPath;
   private final String fCurrentUser;

   public SVNSynchronizationTask(final String pName, final String pProjectID, final String pCodeRepositoryPath, final String pCurrentUSer, SCMRequirementConnector pSVNConnector)
   {
      super(pName);
      fProjectID = pProjectID;
      fCodeRepositoryPath = pCodeRepositoryPath;
      fCurrentUser = pCurrentUSer;
      fSVNConnector = pSVNConnector;
   }
   ...
   public void run()
   {
      try
      {
         fSVNConnector.synchronizeWithCode(fProjectID, fCodeRepositoryPath, fCurrentUser);
      }
