 ...
 * @author sbenoist
 */
public class RequirementPermissionServiceImpl implements RequirementPermissionService
{
   ...
   */
  @Override
  public boolean canExecute(final String pLogin, final String pProjectId)
      throws RequirementPermissionServiceException
  {
    try
    {
      boolean can = false;
    ...
    {
      throw new RequirementPermissionServiceException(String.format(
