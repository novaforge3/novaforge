 ...
 *
 */
public class ExportTestlinkSynchronizationTask extends TaskImpl
{
   ...
   public ExportTestlinkSynchronizationTask(final String pName, final String pProjectID,
         final String pCurrentUSer,
         final TestRequirementConnector pTestlinkConnector)
   {
      super(pName);
