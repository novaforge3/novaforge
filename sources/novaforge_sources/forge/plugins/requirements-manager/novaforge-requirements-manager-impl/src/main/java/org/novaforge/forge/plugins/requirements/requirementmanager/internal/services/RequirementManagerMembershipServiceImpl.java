 ...
 */
public class RequirementManagerMembershipServiceImpl extends AbstractPluginMembershipService implements
    PluginMembershipService
{

  private RequirementOrganizationService requirementOrganizationService;

  public void setRequirementOrganizationService(final RequirementOrganizationService pRequirementOrganizationService)
  {
      ...
      final String pToolRole) throws PluginServiceException
  {
    try
    {
      User user = requirementOrganizationService.buildUser(pUser.getLogin(), pUser.getFirstName(),
          pUser.getName());
      requirementOrganizationService.addMembership(user, pToolRole, pInstance.getToolProjectId());
      return true;
    }
      ...
      final String pToolRole) throws PluginServiceException
  {
    try
    {
      requirementOrganizationService.deleteMembership(pUser.getLogin(), pInstance.getToolProjectId());
      return true;
    }
    catch (RequirementOrganizationServiceException e)
    {
