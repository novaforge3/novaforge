 ...
 * @author rols-p
 */
public class RequirementManagerCategoryServiceImpl extends AbstractPluginCategoryService implements
		RequirementsCategoryService
{

	private static final String PROPERTY_FILE = "requirement";
