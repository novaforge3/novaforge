...
import org.novaforge.forge.plugins.commons.services.DefaultPluginInstanceService;
import org.novaforge.forge.plugins.wiki.dokuwiki.datamapper.DokuwikiResourceBuilder;

/**
 * @author lamirang
 */
public class DokuwikiInstanceImpl extends DefaultPluginInstanceService implements PluginInstanceService
{
  ...
  {
    final String returnId = super.getToolProjectId(pInstanceUuid);
    return dokuwikiResourceBuilder.buildStartingPage(returnId);
  }
