 ...
 * @author lamirang
 */
public class DokuwikiClientException extends Exception
{
    ...
    */
   public DokuwikiClientException(String message, Throwable cause)
   {
      super(message, cause);
   }
    ...
    *           represensts original cause
    */
   public DokuwikiClientException(Throwable cause)
   {
      super(cause);
   }
