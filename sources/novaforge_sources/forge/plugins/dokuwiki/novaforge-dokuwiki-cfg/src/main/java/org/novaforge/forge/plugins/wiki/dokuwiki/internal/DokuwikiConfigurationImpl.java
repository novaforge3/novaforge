...
/**
 * This is a class which contains configuration used to connect to dokuwiki instance.
 * 
 * @author Guillaume Lamirand
 */
public class DokuwikiConfigurationImpl implements DokuwikiConfigurationService
{
  /**
   * Logger instanciation
   */
  private static final Log LOGGER = LogFactory.getLog(DokuwikiConfigurationImpl.class);
  /**
   ...
   */
  private String adminAccess = "http://127.0.0.1/dokuwiki/doku.php?do=login";
  ...
  public void setAdminAccess(final String pAdminAccess)
  {
    ...
    {
      LOGGER.debug(String.format("AdminAccess of plugin '%s' has been changed from '%s' to '%s'.", this
          .getClass().getName(), adminAccess, pAdminAccess));
    }
