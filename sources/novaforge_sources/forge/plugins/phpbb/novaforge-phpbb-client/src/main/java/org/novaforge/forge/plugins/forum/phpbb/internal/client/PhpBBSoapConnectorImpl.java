 ...
 */
public class PhpBBSoapConnectorImpl implements PhpBBSoapConnector
{

   private final String                   username;
   private final String                   password;
   private final PhpBBConnectBindingStub connectBindingStub;
    ...
    */
   public PhpBBSoapConnectorImpl(String pUsername, String pPassword,
		   PhpBBConnectBindingStub pConnectBindingStub)
   {
      username = pUsername;
      password = pPassword;
    ...
    */
   @Override
   public PhpBBConnectBindingStub getConnectBindingStub()
   {
