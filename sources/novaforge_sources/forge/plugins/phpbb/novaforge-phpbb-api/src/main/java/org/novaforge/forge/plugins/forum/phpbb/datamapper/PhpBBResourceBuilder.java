 ...
 */
package org.novaforge.forge.plugins.forum.phpbb.datamapper;
 ...
 * @author caseryj
 */
public interface PhpBBResourceBuilder
{

   PhpbbForum buildProjectData(final PluginProject pPluginProject, final String pInstanceName);

   PhpbbUser buildAccountData(final PluginUser pPluginUser);
