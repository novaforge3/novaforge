 ...
 */
public class PhpBBRoleMappingServiceImpl extends AbstractPluginRolesMappingService implements
    PluginRoleMappingService
{
	...
	{
		return String.valueOf(PhpBBRolePrivilege.fromLabel(pToolRole).getId());
	}
