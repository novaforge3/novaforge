 ...
 * @author salvat-a
 */
public interface AlfrescoFunctionalService
{
   /**
    * @param forgeId
    ...
    */
   AlfrescoRepository getRepository(final String forgeId, final String pluginInstanceId)
         throws AlfrescoFunctionalException;
    ...
    * @throws AlfrescoFunctionalException
    */
   String getSiteUUID(final String forgeId, final String pluginInstanceId) throws AlfrescoFunctionalException;
