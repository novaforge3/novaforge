...
public interface ImportManagementModule
{

  /**
   * initialise the managementModule's Data
   * 
   * @param pProjectPlanManager
   * @param pManagementModuleManager
   * @param pReferentielManager
   * @param pIterationManager
   * @param pForgeManager
   * @param pAuthentificationService
   * @param directoryNfConf
   * @throws Exception
   */
  void init(ProjectPlanManager pProjectPlanManager, ManagementModuleManager pManagementModuleManager,
      ReferentielManager pReferentielManager, IterationManager pIterationManager,
      ForgeConfigurationService pForgeManager, AuthentificationService pAuthentificationService,
      final UserPresenter pUserPresenter, String directoryNfConf) throws Exception;
