...
@NamedQueries({
		@NamedQuery(name = "ScopeTypeEntity.findByName", query = "SELECT p FROM ScopeTypeEntity p WHERE p.name = :name"),
		@NamedQuery(name = "ScopeTypeEntity.findByFunctionalId", query = "SELECT p FROM ScopeTypeEntity p WHERE p.functionalId = :functionalId") })
public class ScopeTypeEntity implements ScopeType, Serializable
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 6941704029680430996L;
	...
	public boolean equals(final Object obj)
	{
		...
		ScopeTypeEntity other = (ScopeTypeEntity) obj;
