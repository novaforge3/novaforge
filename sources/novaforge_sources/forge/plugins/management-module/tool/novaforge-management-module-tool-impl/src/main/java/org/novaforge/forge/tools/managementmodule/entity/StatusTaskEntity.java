...
@NamedQueries({
		@NamedQuery(name = "StatusTaskEntity.findByName", query = "SELECT p FROM StatusTaskEntity p WHERE p.name = :name"),
		@NamedQuery(name = "StatusTaskEntity.findByFunctionalId", query = "SELECT p FROM StatusTaskEntity p WHERE p.functionalId = :functionalId") })
public class StatusTaskEntity implements StatusTask, Serializable
{
	...
	public boolean equals(final Object obj)
	{
		...
		StatusTaskEntity other = (StatusTaskEntity) obj;
	...
	{
		return "StatusTaskEntity [id=" + id + ", name=" + name + "]";
	}
