...
public class UserDAOImpl implements UserDAO
{
  ...
  @Override
  public User findUserByLogin(final String userLogin)
  {

    Query q = entityManager.createNamedQuery("UserEntity.findByLogin");
   ...
   */
  @Override
  public User save(final User pUserData)
  {
    entityManager.persist(pUserData);
    entityManager.flush();
    return pUserData;
  }
   ...
   */
  @Override
  public User merge(final User pUser)
  {
