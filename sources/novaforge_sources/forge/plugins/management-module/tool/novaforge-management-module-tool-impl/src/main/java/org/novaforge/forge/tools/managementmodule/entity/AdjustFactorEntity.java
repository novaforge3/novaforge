 ...
 */
@Entity
@Table(name = "adjust_factor")
@NamedQuery(name = "AdjustFactorEntity.findByName", query = "SELECT p FROM AdjustFactorEntity p WHERE p.name = :name")
public class AdjustFactorEntity implements AdjustFactor, Serializable
{
	/**
	 * 
	 */
	...
	public boolean equals(final Object obj)
	{
		...
		AdjustFactorEntity other = (AdjustFactorEntity) obj;
		if (id == null)
		{
			if (other.id != null)
			{
	...
	{
		return "AdjustFactorEntity [id=" + id + ", name=" + name + "]";
	}
