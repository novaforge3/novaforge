...
/**
 * This class permits to get a server value form a client value on different object types
 */
public class ClientToServerMapper
{
  /**
   * private constructor
   */
  private ClientToServerMapper()
  {
  }
	/**
	 ...
	 * 
	 * @param taskTypeEnum
	 *          the client enum value
	 * @return the TaskType functionalId on server
	 */
	public static String getTaskTypeServerValueFromEnumValue(final TaskTypeEnum taskTypeEnum)
	{
		switch (taskTypeEnum)
		{
			case BUG:
			...
			default:
				throw new IllegalStateException("Unknown " + taskTypeEnum + " value");
		}
	}
}
