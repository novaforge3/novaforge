 ...
 * 
 */
public interface ProjectMonitoringGraphView extends IsWidget {

   /**
    * Return the CustomListBox for the lot
    * @return
    */
   CustomListBox<LotDTO> getLotLB();

   /**
    * Return the CustomListBox for the sub-lot
    * @return
    */
   CustomListBox<LotDTO> getSubLotLB();
   ...
   /**
    * Return the Button who display HomePage
    * @return
    */
