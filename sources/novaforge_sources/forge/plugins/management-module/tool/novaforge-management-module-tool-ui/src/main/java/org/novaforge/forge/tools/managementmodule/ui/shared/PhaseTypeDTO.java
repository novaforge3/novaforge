...
/**
 * The DataTransferObject of Phase Type
 *
 */
public class PhaseTypeDTO implements Serializable
{
	private static final long serialVersionUID = 986875789099L;
	private String			  name;
	...
	public PhaseTypeDTO(String name) {
		super();
		this.name = name;
	}
