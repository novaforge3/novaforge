 ...
 * 
 */
public interface BacklogView extends IsWidget {
	...
	Button getReportTaskButton();

	Button getDeleteButton();

	Button getEndIterationButton();
    ...
    */
   Button getIterationMonitoringButton();

   /**
    * Get the validateFinishIteration
    * @return the validateFinishIteration
    */
   ValidateDialogBox getValidateFinishIteration();
}
