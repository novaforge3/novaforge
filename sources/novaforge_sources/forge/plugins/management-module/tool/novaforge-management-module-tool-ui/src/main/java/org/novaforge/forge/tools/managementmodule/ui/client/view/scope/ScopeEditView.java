 ...
 * @author HUANG-V
 */
public interface ScopeEditView extends IsWidget
{

   TextBox getScopeNameTB();

   TextArea getScopeDescriptionTB();

   ListBox getScopeTypeLB();

   TextBox getScopeVersionTB();
   
   ListBox getScopeLotLB();

   CustomListBox<ScopeUnitDTO> getParentScopeLB();
   ...
   void setMode(ViewEnum pMode, Boolean isManual);
