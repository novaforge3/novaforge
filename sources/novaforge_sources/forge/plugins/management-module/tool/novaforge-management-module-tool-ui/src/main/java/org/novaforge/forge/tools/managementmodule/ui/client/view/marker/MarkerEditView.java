...
public interface MarkerEditView extends IsWidget {

	Label getMarkerNameLabel();

	Label getMarkerDateLabel();

	ListBox getMarkerTypeList();

	Button getButtonAddMarker();

	Button getButtonCancelMarker();

	Button getButtonSaveMarker();

	DateBoxValidation getMarkerDatePicker();

	TextBoxValidation getMarkerNameValidator();

	TextAreaValidation getMarkerDescValidator();
