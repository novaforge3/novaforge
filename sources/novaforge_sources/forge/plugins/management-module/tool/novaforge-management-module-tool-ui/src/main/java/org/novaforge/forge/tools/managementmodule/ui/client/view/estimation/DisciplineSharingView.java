 ...
 *
 */
public interface DisciplineSharingView extends IsWidget {

	ListDataProvider<DisciplineSharingDTO> getDataProvider();
	...
	void setSharingHeader(Set<ProjectDisciplineDTO> pResult);
