...
/**
 * This enum list the different anchor usable for application navigation
 * @see OnClickLinkEvent
 */
public enum AnchorsEnum {
   ...
   ESTIMATION_TAB,
   CHARGE_PLAN_TAB,
   PROJECT_PLAN_SETTINGS_TAB,
   /* Backlog */
   BACKLOG_LIST,
   SCOPE_UNIT_DISCIPLINE_TAB,
   PREPARATION_TAB,
   GLOBAL_MONITORING_TAB,
   REPORT_GLOBAL_TAB,
   REF_ITERATION_TAB,
   ITERATION_MONITORING_TAB,
   BURNDOWN_IT_TAB,
   PROJECT_MONITORING_GRAPH_TAB
