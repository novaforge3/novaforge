...
public interface TransformationDAO
{
	...
	/**
	 * This method returns all instance of Transformation
	 * 
	 * @return List<Transformation>
	 */
	List<Transformation> findAllTransformation();

	Transformation getTransformationOfProject(String idProject);

	/**
	 * @param pId
	 * @return
	 */
	Transformation findById(Long pId);
	 ...
	 * @return
	 */
	Transformation save(Transformation pTransformation);
