 ...
 * 
 */
public interface AdjustFactor extends Serializable
{
	/**
	 * This method returns the name of the adjustment factor
	 * 
	 * @return String
	 */
	String getName();
	...
	/**
	 * This method allows to set the name of the adjustment factor
	 * 
	 * @param name
	 */
