...
import org.novaforge.forge.plugins.management.managementmodule.internal.services.domains.ManagementModuleProxyConfigurationImpl;

/**
 * @author Guillaume Lamirand, Marc Blachon
 */
public class ManagementModuleToolInstanceProvider extends DefaultToolInstanceProvider
{
  ...
  {
    return new ManagementModuleProxyConfigurationImpl(getForgeConfigurationService().getPublicUrl()
        .toExternalForm(), pWebServerName, pProxyId, pPublicAliases, pRedirectUrl);
