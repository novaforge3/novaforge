...
public class AsynchronousJiraRestClientFactoryCustom implements JiraRestClientFactory
{

  @Override
  public AsynchronousJiraRestClientCustom create(final URI serverUri,
      final AuthenticationHandler authenticationHandler)
  {
    final DisposableHttpClient httpClient = new AsynchronousHttpClientFactory().createClient(serverUri,
        authenticationHandler);
    return new AsynchronousJiraRestClientCustom(serverUri, httpClient);
  }
  ...
  {
    final DisposableHttpClient disposableHttpClient = new AsynchronousHttpClientFactory()
        .createClient(httpClient);
    return new AsynchronousJiraRestClientCustom(serverUri, disposableHttpClient);
  }
}
