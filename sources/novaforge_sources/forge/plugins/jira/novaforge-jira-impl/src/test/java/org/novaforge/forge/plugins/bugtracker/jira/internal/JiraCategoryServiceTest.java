 ...
 */
public class JiraCategoryServiceTest
{
  ...
  {
    final JiraCategoryServiceImpl service = new JiraCategoryServiceImpl();
    final String info = service.getApplicationAccessInfo("toto", DEFAULT_LOCALE);
    assertNotNull(info);
