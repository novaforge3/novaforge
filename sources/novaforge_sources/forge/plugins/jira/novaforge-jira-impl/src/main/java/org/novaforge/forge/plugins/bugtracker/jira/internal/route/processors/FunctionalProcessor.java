 ...
 */
package org.novaforge.forge.plugins.bugtracker.jira.internal.route.processors;
...
public class FunctionalProcessor implements Processor
{
  ...
  private final JiraFunctionalService jiraFunctionalService;

  public FunctionalProcessor(final JiraFunctionalService pJiraFunctionalService)
  {
    super();
  ...
  public void process(final Exchange pExchange)
  {
    ...
    try
    {
      logger.info("Jira - Get a functional message.");
      ...
      switch (action)
      {
        case createBug:
          ...
          jiraFunctionalService.createBug(userName, forgeId, instanceId, bean);
          break;
        default:
          break;
      }
