...
/**
 * Jira implementation of {@link PluginRoleMappingService}
 * 
 * @author Guillaume Lamirand
 */
public class JiraRoleMappingServiceImpl extends AbstractPluginRolesMappingService implements
    PluginRoleMappingService
{
  ...
  {
    return String.valueOf(JiraRolePrivilege.fromLabel(pToolRole).getId());
  }
