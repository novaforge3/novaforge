 ...
 */
public class JiraServiceImpl extends AbstractPluginService implements PluginService
{
   ...
   */
  public JiraServiceImpl(final UuidDAO pUuidDAO)
  {
    super(pUuidDAO);
  }
  ...
  protected List<PluginView> buildPluginViews()
  {
    ...
    final JiraConfigurationService jiraConfiguration = getPluginConfigurationService(JiraConfigurationService.class);
    viewList.add(new PluginViewImpl(PluginViewEnum.ADMINISTRATION, jiraConfiguration.getAdminAccess()));
    return viewList;
  }
  ...
  public PluginServiceMetadata getMetadata() throws PluginServiceException
  {
    ...
    if (getServiceUUID() != null)
    {
      pluginServiceMetadata = new PluginMetadataImpl(getServiceUUID(), getDescription(), getType(),
                                                     Category.BUGTRACKER.getId(), new JiraQueues(), getPluginViews(),
                                                     getVersion());
    }
  ...
  public Set<String> findRoles() throws PluginServiceException
  {
    ...
    for (final JiraRolePrivilege roles : JiraRolePrivilege.values())
    {
