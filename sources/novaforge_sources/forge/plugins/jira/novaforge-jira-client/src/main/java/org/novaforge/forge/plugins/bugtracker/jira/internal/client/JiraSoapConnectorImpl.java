 ...
 */
public class JiraSoapConnectorImpl implements JiraSoapConnector
{
  private final String                           authenticationToken;
  private final JirasoapserviceV2SoapBindingStub connectBindingStub;

  /**
   * @param authenticationToken
   * @param connectBindingStub
   */
  public JiraSoapConnectorImpl(final String pAuthenticationToken,
      final JirasoapserviceV2SoapBindingStub pConnectBindingStub)
  {
   ...
   */
  @Override
  public JirasoapserviceV2SoapBindingStub getConnectBindingStub()
  {
