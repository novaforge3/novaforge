 ...
 */
public interface JiraFunctionalService
{
  /**
   * Allow to create a bug on Jira instance.
   * 
   * @param pUserName
   * @param pForgeId
   * @param pInstanceId
  ...
  BugTrackerIssuesBean getProjectIssuesByParameters(final String pForgeId, final String pInstanceId,
      final String pCurrentUser, final JiraGetIssuesFilter pFilter) throws BugTrackerServiceException;
  ...
  Map<BugTrackerStatusBean, List<BugTrackerHistoryValueBean>> getProjectIssueHistoryByStatus(String pForgeId,
      ...
      JiraGetIssuesFilter pFilter) throws BugTrackerServiceException;
   ...
   * @throws BugTrackerServiceException
   */
  List<Status> getAllStatuses(String pForgeId, String pInstanceId, String pCurrentUser)
      throws BugTrackerServiceException;
}
