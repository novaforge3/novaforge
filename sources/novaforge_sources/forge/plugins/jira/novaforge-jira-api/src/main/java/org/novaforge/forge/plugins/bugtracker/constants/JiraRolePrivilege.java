...
public enum JiraRolePrivilege
{
	...
	/**
	 * Represents administrators role
	 */
	ADMINISTRATOR
	{
		@Override
	 ...
	 */
	private static final Map<String, JiraRolePrivilege> roles = new HashMap<String, JiraRolePrivilege>();

	static
	{
		for (final JiraRolePrivilege role : values())
		{
	 ...
	 */
	public static JiraRolePrivilege fromLabel(final String pLabel)
	{
