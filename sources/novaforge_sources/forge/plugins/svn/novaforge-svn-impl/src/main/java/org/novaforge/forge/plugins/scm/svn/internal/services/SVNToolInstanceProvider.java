...
import org.novaforge.forge.plugins.scm.svn.internal.services.domains.SVNProxyConfigurationImpl;

/**
 * @author Guillaume Lamirand
 */
public class SVNToolInstanceProvider extends DefaultToolInstanceProvider
{
  ...
  {
    return new SVNProxyConfigurationImpl(getForgeConfigurationService().getPublicUrl().toExternalForm(),
        pWebServerName, pProxyId, pPublicAliases, pRedirectUrl, getServletUrl());
