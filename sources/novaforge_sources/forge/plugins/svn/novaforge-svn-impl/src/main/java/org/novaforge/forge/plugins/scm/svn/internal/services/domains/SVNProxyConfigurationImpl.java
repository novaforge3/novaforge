...
public class SVNProxyConfigurationImpl extends PluginProxyConfigurationImpl
{

  private static final String SVN          = "/svn";
  private static final String SVNWEBCLIENT = "/svnwebclient";
   ...
   * @param pServletUrl
   */
  public SVNProxyConfigurationImpl(final String pForgePublicUrl, final String pName, final String pProxyId,
      final String pPublicAliases, final String pRedirectUrl, final String pServletUrl)
  {
  ...
  public String getProxySettings()
  {
    ...
    {
      // Servlet alias
      proxyRule.append("<Location ").append(getPublicAlias()).append(SVNRepositoryViewer.SVN_ALIAS_SERVLET)
          .append(">").append(WebServerConfiguratorConstants.FILE_EOL);
      proxyRule.append("\t").append("ProxyPass ").append(servletUrl)
          .append(SVNRepositoryViewer.SVN_ALIAS_SERVLET).append(WebServerConfiguratorConstants.FILE_EOL);
      ...
      // Proxy for /svn
      proxyRule.append("<Location ").append(getPublicAlias()).append(SVN).append(">")
          .append(WebServerConfiguratorConstants.FILE_EOL);
      proxyRule.append("\t").append("RequestHeader edit destination ^https: http:")
          .append(WebServerConfiguratorConstants.FILE_EOL);

      final String redirectUrlWithoutPort = getRedirectURL()
          .replaceAll("(.*)://(.*):[\\d]*(.*)", "$1://$2$3");

      proxyRule.append("\t").append("ProxyPass ").append(redirectUrlWithoutPort).append(getPublicAlias())
          .append(SVN).append(WebServerConfiguratorConstants.FILE_EOL);
      proxyRule.append("\t").append("ProxyPassReverse ").append(redirectUrlWithoutPort)
          .append(getPublicAlias()).append(SVN).append(WebServerConfiguratorConstants.FILE_EOL);
      proxyRule.append("</Location>").append(WebServerConfiguratorConstants.FILE_EOL);

      // Proxy for /svnwebclient
      proxyRule.append("<Location ").append(getPublicAlias()).append(SVNWEBCLIENT).append(">")
          .append(WebServerConfiguratorConstants.FILE_EOL);
      proxyRule.append("\t").append("ProxyPass ").append(getRedirectURL()).append(getPublicAlias())
          .append(SVNWEBCLIENT).append(WebServerConfiguratorConstants.FILE_EOL);
      proxyRule.append("\t").append("ProxyPassReverse ").append(getRedirectURL()).append(getPublicAlias())
          .append(SVNWEBCLIENT).append(WebServerConfiguratorConstants.FILE_EOL);
      proxyRule.append("</Location>").append(WebServerConfiguratorConstants.FILE_EOL);
    }
