 ...
 * @author benoists
 */
public class SVNRoleMappingServiceImpl extends AbstractPluginRolesMappingService implements
    PluginRoleMappingService
{
	...
	{
		Role role = Role.fromLabel(pToolRole);
		if (role == null)
		{
			throw new PluginServiceException("unable to get the svn role from the label:" + role);
		}
		return role.getId();
	}
