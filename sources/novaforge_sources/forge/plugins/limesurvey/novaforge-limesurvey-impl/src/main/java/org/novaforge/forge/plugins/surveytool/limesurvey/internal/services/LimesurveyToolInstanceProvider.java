...
import org.novaforge.forge.plugins.surveytool.limesurvey.internal.services.domains.LimesurveyProxyConfigurationImpl;

/**
 * @author Guillaume Lamirand
 */
public class LimesurveyToolInstanceProvider extends DefaultToolInstanceProvider
{
  ...
  {
    return new LimesurveyProxyConfigurationImpl(getForgeConfigurationService().getPublicUrl().toExternalForm(),
         pWebServerName, pProxyId, pPublicAliases, pRedirectUrl);
