 ...
 * @author vvigo
 */
public class LimesurveyRoleMappingServiceImpl extends AbstractPluginRolesMappingService implements
		PluginRoleMappingService
{
	...
	{
		return String.valueOf(LimesurveyRolePrivilege.fromLabel(pToolRole).getId());
	}
}
