...
/**
 * This enumeration declares default roles which are used on limesurvey
 * 
 * @author vvigo
 */
public enum LimesurveyRolePrivilege
{
  ...
  ADMINISTRATOR
  {
    ...
    {
      return LimesurveyEnumConstant.ADMINISTRATOR_LABEL;
    }
  ...
  /**
   * Represents observer role. It can only read page on surveytool.
   */
  OBSERVER
  {
    @Override
    public String getLabel()
    {
      return LimesurveyEnumConstant.OBSERVER_LABEL;
    }
   ...
   */
  private static final Map<String, LimesurveyRolePrivilege> roles = new HashMap<String, LimesurveyRolePrivilege>();

  static
  {
    for (final LimesurveyRolePrivilege role : values())
    {
   ...
   */
  public static LimesurveyRolePrivilege fromLabel(final String pLabel)
  {
