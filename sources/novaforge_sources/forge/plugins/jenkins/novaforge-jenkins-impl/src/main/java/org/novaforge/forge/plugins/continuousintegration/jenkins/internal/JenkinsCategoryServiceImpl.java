 ...
 * @author rols-p
 */
public class JenkinsCategoryServiceImpl extends AbstractPluginCategoryService implements CICategoryService
{

	private static final String PROPERTY_FILE = "jenkins";
