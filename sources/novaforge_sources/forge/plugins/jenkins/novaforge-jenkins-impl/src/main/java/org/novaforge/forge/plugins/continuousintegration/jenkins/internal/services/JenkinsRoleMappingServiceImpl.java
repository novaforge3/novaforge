 ...
 * @author sbenoist
 */
public class JenkinsRoleMappingServiceImpl extends AbstractPluginRolesMappingService implements
    PluginRoleMappingService
{
	...
	public String getToolRoleId(final String pToolRole) throws PluginServiceException
	{
		...
		if (role == null)
		{
			throw new PluginServiceException("unable to get the jenkins role from the label:" + pToolRole);
		}
		return role.getId();
	}
}
