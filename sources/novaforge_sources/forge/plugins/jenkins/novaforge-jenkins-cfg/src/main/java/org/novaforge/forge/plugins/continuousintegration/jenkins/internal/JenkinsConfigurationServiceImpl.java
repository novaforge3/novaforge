 ...
 */
public class JenkinsConfigurationServiceImpl implements JenkinsConfigurationService
{
	...
	/**
	 * Admin URL of jenkins instance
	 */
	private String                     adminAccess = "/securityRealm/commenceLogin";
