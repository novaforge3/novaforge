 ...
 */
public class TestlinkFunctionalRoute extends AbstractPluginDataRoute
{
	...
	{
		return TestlinkQueueName.TESTLINK_FUNCTIONAL_QUEUE;
	}
	...
	{
		return TestlinkQueueName.TESTLINK_FUNCTIONAL_ROUTE;
	}
	...
	{
		return new FunctionalProcessor(testlinkFunctionalService);
	}

	/**
	 * @param pTestlinkFunctionalService
	 *          represents the service to inject
	 */
