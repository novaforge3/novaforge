 ...
 * @date 25 juil. 2011
 */
public class TestlinkRoleMappingServiceImpl extends AbstractPluginRolesMappingService implements
    PluginRoleMappingService
{
	...
	{
		return String.valueOf(TestlinkRolePrivilege.fromLabel(pToolRole).getName());
	}
