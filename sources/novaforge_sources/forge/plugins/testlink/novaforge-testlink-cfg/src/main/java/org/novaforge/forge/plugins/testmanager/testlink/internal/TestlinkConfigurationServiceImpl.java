 ...
 */
public class TestlinkConfigurationServiceImpl implements TestlinkConfigurationService
{
	...
	/**
	 * Admin URL of testlink instance
	 */
	private String                     adminAccess = "http://127.0.0.1/testlink/login.php";
