 ...
 */
public class GitlabRoleMappingServiceImpl extends AbstractPluginRolesMappingService implements
    PluginRoleMappingService
{
  ...
  {
    return String.valueOf(GitlabRole.fromLabel(pToolRole).getId());
  }
