 ...
 */
public class GitlabBrowse
{
  public static final String         GITLAB_ALIAS_SERVLET = "/gitlabBrowse";
  ...
  /**
   * Reference to service implementation of {@link HttpService}
   */
  ...
  public void init() throws PluginServiceException
  {
    ...
    try
    {
      httpService.registerServlet(GITLAB_ALIAS_SERVLET, new GitlabBrowseServlet(gitlabConfigurationService,
          instanceConfigurationDAO, toolInstanceDAO), null, null);
      isServletRegister = true;
    }
    catch (final ServletException e)
    {
      throw new PluginServiceException(String.format(
          "Unable to register Gitlab browse servlet with [alias=%s]", GITLAB_ALIAS_SERVLET), e);
    }
    catch (final NamespaceException e)
    {
      throw new PluginServiceException(String.format(
          "Unable to register tool gadget descriptor servlet with [alias=%s]", GITLAB_ALIAS_SERVLET), e);
    }
  }
  ...
  public void destroy()
  {
    ...
    {
      httpService.unregister(GITLAB_ALIAS_SERVLET);
   ...
   *          the gitlabConfigurationService to set
   */
  public void setGitlabConfigurationService(final GitlabConfigurationService pGitlabConfigurationService)
  {
