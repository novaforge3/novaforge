 ...
 */
package org.novaforge.forge.plugins.bucktracker.mantis.datamapper;
 ...
 * @author lamirang
 */
public interface MantisResourceBuilder
{
   ...
   BugTrackerIssueBean buildBugTrackerIssueBean(final IssueData pIssueData);
