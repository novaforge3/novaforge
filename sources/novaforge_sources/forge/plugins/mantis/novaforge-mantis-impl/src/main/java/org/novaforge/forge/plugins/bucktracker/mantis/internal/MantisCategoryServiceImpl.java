...
import org.novaforge.forge.plugins.bucktracker.mantis.internal.services.MantisGetIssuesFilterImpl;
    ...
    BugTrackerCategoryService
{
  ...
  private static final String     PROPERTY_FILE = "mantis";

  /**
   * Reference to service implementation of {@link MantisSoapClient}
   */
  private MantisFunctionalService mantisFunctionalService;
  ...
  {
    return mantisFunctionalService.getAllProjectVersions(pForgeId, pInstanceId, pCurrentUser);
  }
      ...
      final String pCurrentUser, final String pJSONParameter) throws BugTrackerServiceException
  {
    ...
    return mantisFunctionalService.getProjectIssuesByParameters(pForgeId, pInstanceId, pCurrentUser, filter);
  }
  ...
  {
    return mantisFunctionalService.getIssue(pForgeId, pInstanceId, pCurrentUser, pBugTrackerId);
  }
      ...
      throws BugTrackerServiceException
  {
    ...
    return mantisFunctionalService.getProjectIssueHistoryByStatus(pForgeId, pInstanceId, pCurrentUser, pStart, pEnd,
                                                                  pIncrement, filter);
  }
   ...
   */
  public void setMantisFunctionalService(final MantisFunctionalService pMantisFunctionalService)
  {
