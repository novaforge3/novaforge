...
import org.novaforge.forge.plugins.bugtracker.mantis.arc.services.MantisConfigurationService;
 ...
 */
public class MantisConfigurationServiceImpl implements MantisConfigurationService
{
   ...
   */
  private String                     adminAccess = "http://127.0.0.1/mantis_arc/login.php";

  /**
   * BIRT TOOL URL
   */
  private String                     birtAccess;

  /**
   * Birt label in left menu
   */
  private String                     birtLabel;
   ...
   * @param pBirtLabel
   */
  public void setBirtLabel(final String pBirtLabel)
  {
    birtLabel = pBirtLabel;
  }
   ...
   * @param pBirtAccess
   */
  public void setBirtAccess(final String pBirtAccess)
  {
    birtAccess = pBirtAccess;
  }
