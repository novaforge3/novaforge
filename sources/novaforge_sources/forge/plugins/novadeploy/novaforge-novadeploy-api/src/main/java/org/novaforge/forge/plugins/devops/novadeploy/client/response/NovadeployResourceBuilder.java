...
import org.novaforge.forge.plugins.devops.novadeploy.client.data.NovadeployUser;

/**
 * @author dekimpea
 *
 */
public interface NovadeployResourceBuilder
{
	 ...
	 * @return
	 */
	NovadeployUser buildNovadeployUser(PluginUser pPluginUser);

	/**
	 * @param pPageIdPluginProject
	 * @return
	 */
	String buildNovadeployNameSpace(String pPageIdPluginProject);
