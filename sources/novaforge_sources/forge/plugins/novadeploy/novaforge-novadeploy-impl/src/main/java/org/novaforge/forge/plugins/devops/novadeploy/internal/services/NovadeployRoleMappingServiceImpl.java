 ...
 * @author dekimpea
 */
public class NovadeployRoleMappingServiceImpl extends AbstractPluginRolesMappingService implements
    PluginRoleMappingService
{
  ...
  {
    return String.valueOf(NovadeployRolePrivilege.fromLabel(pToolRole).getId());
