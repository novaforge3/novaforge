...
/**
 * This is an implementation of PluginRoleMappingService for Nexus plugin.
 * 
 ...
 * @author lamirang
 */
public class NexusRoleMappingServiceImpl extends AbstractPluginRolesMappingService implements
    PluginRoleMappingService
{
	...
	{
		return NexusRolePrivilege.fromLabel(pToolRole).getId();
	}
}
