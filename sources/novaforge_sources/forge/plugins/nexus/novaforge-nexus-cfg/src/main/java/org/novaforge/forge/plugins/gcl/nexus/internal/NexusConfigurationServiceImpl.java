 ...
 */
public class NexusConfigurationServiceImpl implements NexusConfigurationService
{
	...
	/**
	 * Admin URL of nexus instance
	 */
	private String                     adminAccess = "http://localhost:8081/nexus/service/local/authentication/login";
