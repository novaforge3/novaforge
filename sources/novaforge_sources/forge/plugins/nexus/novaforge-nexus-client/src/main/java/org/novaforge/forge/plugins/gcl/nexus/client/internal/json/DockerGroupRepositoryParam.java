...
public class DockerGroupRepositoryParam extends GroupRepositoryParam {
	...
	public DockerGroupRepositoryParam(String name, Integer httpPort, Integer httpsPort) {
		super(name);
		this.httpPort = httpPort;
		this.httpsPort = httpsPort;
	}
	
	public DockerGroupRepositoryParam(String name, String blobStoreName, Integer httpPort, Integer httpsPort, boolean v1Enabled) {
		super(name);
		this.httpPort = httpPort;
		this.httpsPort = httpsPort;
	...
	public String toString() {
		return "DockerGroupRepositoryParam [name=" + name + ", members=" + members + ", blobStoreName=" + blobStoreName
