...
def repo=repository.createMavenGroup(groupRepositoryParam.name,groupRepositoryParam.members,groupRepositoryParam.blobStoreName);
...
def jsonResult = '{' + "\"type\":\"" + type + "\",\"format\":\"" +  format + "\",\"name\":\"" + repo.getName() + "\",\"url\":\"" + repo.getUrl() + "\",\"versionPolicy\":\"" + versionPolicy + "\",\"members\":" + members + "\"}";
return jsonResult