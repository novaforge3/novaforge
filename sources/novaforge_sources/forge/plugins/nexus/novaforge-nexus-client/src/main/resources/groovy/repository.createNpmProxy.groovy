...
def repo=repository.createNpmProxy(proxyRepositoryParam.name,proxyRepositoryParam.remoteUrl,proxyRepositoryParam.blobStoreName,proxyRepositoryParam.strictContentTypeValidation);
