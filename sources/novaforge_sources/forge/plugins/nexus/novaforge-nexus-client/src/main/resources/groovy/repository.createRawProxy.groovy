...
def repo=repository.createRawProxy(proxyRepositoryParam.name,proxyRepositoryParam.remoteUrl,proxyRepositoryParam.blobStoreName,proxyRepositoryParam.strictContentTypeValidation);
