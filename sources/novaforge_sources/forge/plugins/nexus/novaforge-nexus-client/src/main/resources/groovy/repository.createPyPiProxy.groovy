...
def repo=repository.createPyPiProxy(proxyRepositoryParam.name,proxyRepositoryParam.remoteUrl,proxyRepositoryParam.blobStoreName,proxyRepositoryParam.strictContentTypeValidation);
