...
def repo=repository.createNugetProxy(proxyRepositoryParam.name,proxyRepositoryParam.remoteUrl,proxyRepositoryParam.blobStoreName,proxyRepositoryParam.strictContentTypeValidation);
