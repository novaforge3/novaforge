...
import org.novaforge.forge.plugins.bucktracker.mantisstd.internal.services.MantisGetIssuesFilterImpl;
    ...
    BugTrackerCategoryService
{
  ...
  private static final String     PROPERTY_FILE = "mantisstd";

  /**
   * Reference to service implementation of {@link MantisSoapClient}
   */
  private MantisFunctionalService mantisStdFunctionalService;
  ...
  {
    return mantisStdFunctionalService.getAllProjectVersions(pForgeId, pInstanceId, pCurrentUser);
  }
      ...
      final String pCurrentUser, final String pJSONParameter) throws BugTrackerServiceException
  {
    ...
    return mantisStdFunctionalService.getProjectIssuesByParameters(pForgeId, pInstanceId, pCurrentUser, filter);
  }
  ...
  {
    return mantisStdFunctionalService.getIssue(pForgeId, pInstanceId, pCurrentUser, pBugTrackerId);
  }
      ...
      throws BugTrackerServiceException
  {
    ...
    return mantisStdFunctionalService.getProjectIssueHistoryByStatus(pForgeId, pInstanceId, pCurrentUser, pStart, pEnd,
                                                                     pIncrement, filter);
  }
   ...
   */
  public void setMantisStdFunctionalService(final MantisFunctionalService pMantisFunctionalService)
  {
    mantisStdFunctionalService = pMantisFunctionalService;
  }
