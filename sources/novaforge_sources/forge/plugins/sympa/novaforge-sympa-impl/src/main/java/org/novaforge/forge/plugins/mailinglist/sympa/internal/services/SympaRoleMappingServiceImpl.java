 ...
 * @author sbenoist
 */
public class SympaRoleMappingServiceImpl extends AbstractPluginRolesMappingService implements
		PluginRoleMappingService
{
	...
	{
		// there is no roles managed by sympa directly linked to users (roles are linked to users and lists)
		throw new PluginServiceException("Not implemented for this tool");
	}
}
