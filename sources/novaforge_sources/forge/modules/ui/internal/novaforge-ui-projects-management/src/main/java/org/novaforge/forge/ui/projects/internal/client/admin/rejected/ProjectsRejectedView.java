...
/**
 * This interface describes the view used to list project which has been rejected
 * 
 * @author Guillaume Lamirand
 */
public interface ProjectsRejectedView extends ComponentContainer
{
  ...
  /**
   * Return {@link TextField} used to filter project's table
   * 
   * @return {@link TextField} used to filter project's table
   */
