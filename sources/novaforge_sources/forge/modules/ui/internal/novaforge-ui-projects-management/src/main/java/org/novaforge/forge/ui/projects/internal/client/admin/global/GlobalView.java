...
public interface GlobalView extends ComponentContainer
{
  ...
  /**
   * This method allows to return the {@link Button} used for projects menu
   * 
  ...
  /**
   * This method allows to return the {@link Button} used for requests menu
   * 
  ...
  /**
   * This method allows to return the {@link Button} used for rejected menu
   * 
