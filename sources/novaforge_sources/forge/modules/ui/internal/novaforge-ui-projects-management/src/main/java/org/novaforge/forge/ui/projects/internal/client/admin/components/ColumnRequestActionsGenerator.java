 ...
 */
public class ColumnRequestActionsGenerator implements ColumnGenerator
{
  /**
   * Serial version id
   */
  ...
  private final ProjectsRequestPresenter presenter;
   ...
   */
  public ColumnRequestActionsGenerator(final ProjectsRequestPresenter pPresenter)
  {
    super();
  ...
  public Object generateCell(final com.vaadin.ui.Table pSource, final Object pItemId, final Object pColumnId)
  {
    ...
    if (pSource.getParent() != null)
    {
      ...
      // ACTION delete user
      final Embedded invalidIcon = new Embedded(null,
      ...
      invalidIcon.setDescription(ProjectServices.getPortalMessages().getMessage(pSource.getLocale(),
