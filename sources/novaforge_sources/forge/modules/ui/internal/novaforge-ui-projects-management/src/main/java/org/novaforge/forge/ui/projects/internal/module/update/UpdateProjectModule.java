 ...
 */
public class UpdateProjectModule implements PortalModule
{
  ...
  public String getId()
  {
    return UpdateProjectModule.getPortalModuleId().getId();
  }
  ...
  {
    return PortalModuleId.UPDATE_PROJECT;
  }
  ...
  {
    return new UpdateProjectComponent(pPortalContext);
  }
