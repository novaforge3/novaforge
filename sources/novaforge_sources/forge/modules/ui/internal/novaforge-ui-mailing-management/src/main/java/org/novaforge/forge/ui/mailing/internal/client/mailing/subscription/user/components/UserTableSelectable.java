...
public class UserTableSelectable extends VerticalLayout
{
  ...
  private void addListeners()
  {
    usersTable.addValueChangeListener(new ValueChangeListener()
    {
      ...
      {
        selectedUsers = new HashSet<String>((Set<String>) usersTable.getValue());
        selectedLayout.removeAllComponents();
        for (final String login : selectedUsers)
        {
  ...
  public void refreshLocale(final Locale pLocale)
  {
    filterForm.setCaption(MailingModule.getPortalMessages().getMessage(pLocale,
        Messages.MAILING_LISTS_USERS_LIST_TITLE));
    filterForm.setDescription(MailingModule.getPortalMessages().getMessage(pLocale,
        Messages.MAILING_LISTS_USERS_LIST_DESCRIPTION));
    ...
    usersTable.setColumnHeader(UserItemProperty.LOGIN.getPropertyId(), MailingModule.getPortalMessages()
        .getMessage(pLocale, Messages.MAILING_LISTS_USERS_LOGIN));
    usersTable.setColumnHeader(UserItemProperty.FIRSTNAME.getPropertyId(), MailingModule.getPortalMessages()
        .getMessage(pLocale, Messages.MAILING_LISTS_USERS_FIRSTNAME));
    usersTable.setColumnHeader(UserItemProperty.LASTNAME.getPropertyId(), MailingModule.getPortalMessages()
        .getMessage(pLocale, Messages.MAILING_LISTS_USERS_NAME));
    usersTable.setColumnHeader(UserItemProperty.EMAIL.getPropertyId(), MailingModule.getPortalMessages()
        .getMessage(pLocale, Messages.MAILING_LISTS_USERS_EMAIL));
    selectedLayout.setCaption(MailingModule.getPortalMessages().getMessage(pLocale,
        Messages.MAILING_LISTS_USERS_LIST_SELECTED));
  }
   ...
   * @return {@link Set} of user login selecting
   */
  public Set<String> getSelectedUser()
  {
