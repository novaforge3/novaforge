 ...
 */
public class GroupColumnSelectGenerator implements ColumnGenerator
{
  /**
   * Serial version id
   */
  ...
  public Object generateCell(final com.vaadin.ui.Table pSource, final Object pItemId, final Object pColumnId)
  {
    ...
    //TODO
    selectBox.setDescription(MailingModule.getPortalMessages().getMessage(UI.getCurrent().getLocale(),
        Messages.MAILING_LIST_USERS_SELECT_DESCRIPTION));
