 ...
 * @author sbenoist
 */
public class ShowMailingListDetailsViewEvent implements PortalEvent
{
  ...
  private final MailingListBean mailinglist;
   ...
   */
  public ShowMailingListDetailsViewEvent(final MailingListBean pMailingListBean, final UUID pModuleUUID)
  {
    super();
    mailinglist = pMailingListBean;
   ...
   */
  public MailingListBean getMailinglist()
  {
    return mailinglist;
  }
