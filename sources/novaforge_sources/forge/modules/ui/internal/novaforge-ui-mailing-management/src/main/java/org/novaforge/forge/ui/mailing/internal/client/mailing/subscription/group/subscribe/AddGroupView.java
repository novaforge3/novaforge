 ...
 */
public interface AddGroupView extends ComponentContainer
{
  ...
  /**
   * Return {@link GroupTableSelectable} used to manage selecting users
   * 
   * @return {@link GroupTableSelectable}
   */
  GroupTableSelectable getGroupTableSelectable();
}
