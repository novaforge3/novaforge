...
/**
 * Used to select back the parent space of an application
 * 
 * @author Guillaume Lamirand
 */
public class SelectParentEvent implements PortalEvent
{
   ...
   */
  public SelectParentEvent(final Space pSpace, final UUID pModuleUUID)
  {
    space = pSpace;
  ...
  /**
   * Return the {@link Space} to select
   * 
   * @return the {@link Space} to select
   */
