...
/**
 * This event is sent to display default view on the right
 * 
 * @author Guillaume Lamirand
 */
public class DisplayDefaultRightEvent implements PortalEvent
{
  /**
   ...
   */
  public DisplayDefaultRightEvent(final UUID pModuleUUID)
  {
