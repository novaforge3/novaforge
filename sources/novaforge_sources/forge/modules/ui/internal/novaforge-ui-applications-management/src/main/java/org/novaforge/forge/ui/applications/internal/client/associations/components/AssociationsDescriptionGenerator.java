 ...
 */
public class AssociationsDescriptionGenerator implements ItemDescriptionGenerator
{
  ...
  public String generateDescription(final Component pSource, final Object pItemId, final Object pPropertyId)
  {
    ...
    if (pSource instanceof TreeTable)
    {
      final TreeTable treeTable = (TreeTable) pSource;
      final Property<?> availability = treeTable.getContainerProperty(pItemId,
          ItemProperty.AVAILABILITY.getPropertyId());
      final Property<?> compatible = treeTable.getContainerProperty(pItemId,
      ...
      {
        final Property<?> description = treeTable.getContainerProperty(pItemId,
        ...
        {
          final Property<?> caption = treeTable.getContainerProperty(pItemId,
