...
/**
 * Used to display application details view
 * 
 * @author Guillaume Lamirand
 */
public class ShowApplicationEvent implements PortalEvent
{
   ...
   */
  public ShowApplicationEvent(final ProjectApplication pProjectApplication, final UUID pModuleUUID)
  {
  ...
  /**
   * Return {@link ProjectApplication} to display
   * 
   * @return {@link ProjectApplication} displayed
   */
