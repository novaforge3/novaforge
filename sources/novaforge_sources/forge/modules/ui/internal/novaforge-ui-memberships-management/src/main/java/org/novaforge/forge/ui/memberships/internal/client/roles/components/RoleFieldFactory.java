...
/**
 * This {@link RoleFieldFactory} is used to build a role form
 * 
 * @author Guillaume Lamirand
 */
public class RoleFieldFactory extends DefaultFieldFactory
{
  /**
  ...
  /**
   * Return {@link Role} description
   * 
   * @return {@link Role} description field
   */
