...
public enum GroupItemProperty
{
   ...
   */
  public static final String[] GROUP_FORGE_FIELDS = new String[] { GroupFieldFactory.NAME_FIELD,
      GroupFieldFactory.DESCRIPTION_FIELD, GroupFieldFactory.VISIBILITY_FIELD };
  /**
   * Contains the array of fields to display in the form
   */
  public static final String[] GROUP_FIELDS       = new String[] { GroupFieldFactory.NAME_FIELD,
      GroupFieldFactory.DESCRIPTION_FIELD        };
