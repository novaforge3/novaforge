 ...
 */
public class ProjectsColumnUserGenerator implements ColumnGenerator
{
  /**
   * Serial version id
   */
   ...
   */
  public ProjectsColumnUserGenerator(final InstancesListPresenter pPresenter)
  {
    super();
  ...
  public Object generateCell(final com.vaadin.ui.Table pSource, final Object pItemId, final Object pColumnId)
  {
    ...
    final UserProfile userProfile = (UserProfile) item.getItemProperty(
        ProjectInstanceItemProperty.AUTHOR.getPropertyId()).getValue();
    if (userProfile != null)
    {
      ...
      button.addClickListener(new ClickListener()
      {
        ...
        {
          presenter.showAuthorProfile(userProfile);
