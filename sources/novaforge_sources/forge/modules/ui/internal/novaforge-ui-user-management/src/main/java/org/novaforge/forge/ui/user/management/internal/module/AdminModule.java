 ...
 * @author caseryj
 */
public class AdminModule implements PortalModule
{
   ...
   */
  private static ForgeConfigurationService FORGE_PRESENTER;
  /**
  ...
  {
    return PortalModuleId.USERMANAGEMENT_ADMIN;
  }
  ...
  {
    return new AdminComponent(pPortalContext);
  }
