...
import org.novaforge.forge.ui.user.management.internal.client.userpublicprofile.UserPublicProfileView;
import org.novaforge.forge.ui.user.management.internal.client.userpublicprofile.UserPublicProfileViewImpl;

/**
 * @author caseryj
 */
public class PublicComponent extends AbstractPortalComponent
{

  /**
   * The user public profile presenter
   */
  private final UserPublicProfilePresenter userPublicProfilePresenter;
  /**
   * The user login
   */
   ...
   */
  public PublicComponent(final PortalContext pPortalContext)
  {
    super(pPortalContext);

    userLogin = pPortalContext.getAttributes().get(PortalContext.KEY.LOGIN);

    final UserPublicProfileView view = new UserPublicProfileViewImpl();
    view.addStyleName(NovaForge.NOVAFORGE_APPLICATION_CONTENT);
    userPublicProfilePresenter = new UserPublicProfilePresenter(view, pPortalContext);
    setContent(view);
  }
  ...
  public void init()
  {
    userPublicProfilePresenter.refresh(userLogin);
  }
