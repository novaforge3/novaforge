...
public final class NovadeployRestConstant
{
	...
	public static final String Novadeploy_METHOD_RESOURCES_CLOUD = "/cloud/resources";

	public static final String Novadeploy_METHOD_GET_ACCOUNT_MEMBERSHIPS = "/cloud/organization";

	public static final String Novadeploy_METHOD_GET_USER_ROLE_FROM_PROJECT = "/cloud/user/role";
	/**
