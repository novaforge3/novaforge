...
public interface NovadeployRestClient
{
	 ...
	 */
	NovadeployClient getConnector(final String pToolUrl, final String pUsername, final String pPassword)
			throws NovadeployClientException;
	 ...
	 * @throws NovadeployClientException
	 */
	DescriptorResponse getDescriptor(NovadeployClient connector, int descriptorVersion, String descriptorName,
	 ...
	 * @param connector
	 * @param pProject
	 * @return the membership of the logged user
	 * @throws NovadeployClientException
	 */
	Membership getUserMembershipFromProject(NovadeployClient connector, String pProject)
			throws NovadeployClientException;
	 ...
	 * @param connector
	 * @param project
	 * @return an object representing vCloud Account resources
	 * @throws NovadeployClientException
	 */
	OrgResources getAccountResources(NovadeployClient connector, String project) throws NovadeployClientException;
}
