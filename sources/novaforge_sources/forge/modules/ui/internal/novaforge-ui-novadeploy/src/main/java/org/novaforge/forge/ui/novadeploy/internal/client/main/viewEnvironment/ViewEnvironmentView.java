 ...
 */
public interface ViewEnvironmentView extends ComponentContainer
{
	/**
	...
	Button getShowDescriptorButton();

	long getEnvironmentId();

	String getDescriptorName();

	void prepareView(String descriptorName, long timeRefId, String[] logLines, CustomerEnvironment env);

	void setPresenter(ViewEnvironmentPresenter viewEnvironmentPresenter);
