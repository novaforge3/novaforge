 ...
 */
public interface LoginCloudView extends ComponentContainer
{
	/**
	...
	String getCloudNameField();

	String getLoginField();

	String getPasswordField();

	String getDataCloudName();

	String getDataLogin();

	String getDataPassword();

	void setDataCloudName(String cloudName);

	void setDataLogin(String login);

	void setDataPassword(String password);
}
