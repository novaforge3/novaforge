 ...
 * @author qsivan
 */
public interface LoggingPurgeView extends IsWidget
{

  Button getButtonValidatePurge();

  ValidatePurgeDialogBox getValidatePurgeDialogBox();

  DateBox getLimitDateBox();
}
