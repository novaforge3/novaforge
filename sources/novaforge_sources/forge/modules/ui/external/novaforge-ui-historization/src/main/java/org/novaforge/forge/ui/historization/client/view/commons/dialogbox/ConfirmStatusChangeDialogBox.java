 ...
 * @author qsivan
 */
public class ConfirmStatusChangeDialogBox
{
  ...
  public ConfirmStatusChangeDialogBox(final String pContent)
  {
    ...
    validateButton = new Button(globalMessages.buttonConfirm());
    buttonPanel.add(validateButton);

    closeButton = new Button(globalMessages.buttonCancel(), new ClickHandler()
    {
      @Override
