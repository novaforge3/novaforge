...
public interface RoleMessage extends Messages
{
  ...
  String roleNameValidation();

  String roleDescValidation();

  String roleErrorValidation();

  String mandatoryDelete();

  String mandatoryMapping();
