...
public interface GroupMessage extends Messages
{
  ...
  String emptyUserMessage();

  String emptyGroupFilterMessage();
  ...
  String groupeNameValidation();

  String groupeDescValidation();

  String groupeErrorValidation();
