...
public class GetFileListCallbackVO extends JsonableBaseVO implements Jsonable, Serializable
{
	/**
    * 
    */
	private static final long    serialVersionUID = 7831691358996365200L;
	private List<AnalyzedFileVO> filesData;

	public List<AnalyzedFileVO> getFilesData()
	{
		return filesData;
	}

	public void setFilesData(final List<AnalyzedFileVO> filesData)
	{
	...
	protected Object getData()
	{
		...
		if (filesData != null)
		{
			for (final AnalyzedFileVO elem : filesData)
			{
