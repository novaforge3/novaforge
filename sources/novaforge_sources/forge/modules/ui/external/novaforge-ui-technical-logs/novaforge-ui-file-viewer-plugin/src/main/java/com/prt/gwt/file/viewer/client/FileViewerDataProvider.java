...
public class FileViewerDataProvider implements DataProvider {
   private FileManagerServiceAsync managerServiceAsync = GWT.create(FileManagerServiceAsync.class);

   public void getFileList( final AsyncCallback<GetFileListCallbackVO> callback) {
      managerServiceAsync.getFileList(callback);
   }

   public void getFileData(final BaseFileVO file, final long startWith, final long lines, final boolean tail, final AsyncCallback<BaseFileDataVO> callback) {
