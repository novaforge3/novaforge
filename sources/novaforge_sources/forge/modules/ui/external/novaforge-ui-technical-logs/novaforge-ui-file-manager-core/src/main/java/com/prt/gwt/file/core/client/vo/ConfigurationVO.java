...
public class ConfigurationVO extends JsonableBaseVO
{
	/**
    * 
    */
	private static final long serialVersionUID = -7487627023975640008L;
	...
	public void setLocalLogDir(final String localLogDir)
	{
	...
	{
		localLogDir = (String) d.get("localLogDir");
	}
}
