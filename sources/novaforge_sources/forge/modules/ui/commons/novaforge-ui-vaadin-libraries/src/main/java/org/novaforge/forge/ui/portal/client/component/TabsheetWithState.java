...
/**
 * This custom tabsheet keeps state of each tab's component to avoid {@link Embedded} to be refreshed when
 * selected tab changed. Because of private fields and methods this component has to duplicate a lot of code
 * from original Tabsheet component.
 * Two things has been changed
 * <ol>
 * <li>Delete SelectiveRenderer interface</li>
 * <li>Do not makeAsDurty the new selected tab</li>
 * </ol>
 */
public class TabsheetWithState extends com.vaadin.ui.AbstractComponentContainer
    implements com.vaadin.ui.Component.Focusable, FieldEvents.FocusNotifier, FieldEvents.BlurNotifier
{
  ...
  static
  {
    try
    {
      SELECTED_TAB_CHANGE_METHOD = org.novaforge.forge.ui.portal.client.component.TabsheetWithState.SelectedTabChangeListener.class
   ...
   * the tab.
   */
  private final java.util.ArrayList<com.vaadin.ui.Component>                                                                     components   = new java.util.ArrayList<com.vaadin.ui.Component>();
  /**
   * Map containing information related to the tabs (caption, icon etc).
   */
  private final java.util.HashMap<com.vaadin.ui.Component, org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab> tabs         = new java.util.HashMap<com.vaadin.ui.Component, org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab>();
  /**
  ...
  private final TabsheetServerRpcImpl                 rpc          = new org.novaforge.forge.ui.portal.client.component.TabsheetWithState.TabsheetServerRpcImpl();
  private final FieldEvents.FocusAndBlurServerRpcImpl focusBlurRpc = new FieldEvents.FocusAndBlurServerRpcImpl(this)
  {
    ...
    {
      org.novaforge.forge.ui.portal.client.component.TabsheetWithState.this.fireEvent(event);
    }
  };
  /**
   * Selected tab content component.
   */
  private       com.vaadin.ui.Component               selected     = null;
  /**
   * Handler to be called when a tab is closed.
   */
  private org.novaforge.forge.ui.portal.client.component.TabsheetWithState.CloseHandler closeHandler;
   ...
   */
  public TabsheetWithState(final com.vaadin.ui.Component... components)
  {
    this();
  ...
  /**
   * Constructs a new {@link TabsheetWithState}. A TabsheetWithState is immediate by default, and the
   * default close handler removes the tab being closed.
   */
  public TabsheetWithState()
  {
    super();
    ...
    setCloseHandler(new org.novaforge.forge.ui.portal.client.component.TabsheetWithState.CloseHandler()
    {
      ...
      @Override
      public void onTabClose(final org.novaforge.forge.ui.portal.client.component.TabsheetWithState tabsheet,
  ...
  /**
   * Provide a custom {@link CloseHandler} for this TabsheetWithState if you wish to
   ...
   * The default CloseHandler for TabsheetWithState will only remove the tab.
   *
   * @param handler
   */
  public void setCloseHandler(final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.CloseHandler handler)
  {
    closeHandler = handler;
  }

  /**
   * Sets the selected tab in the TabsheetWithState. Ensures that the selected tab is
   * repainted if needed.
   *
   * @param component
  ...
  {
    org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab tab = tabs.get(selected);

    selected = component;
    // We don't want to repaint selected component because this Tabsheet used lastest state
  ...
  private boolean updateSelection()
  {
    ...
    for (final java.util.Iterator<com.vaadin.ui.Component> i = getComponentIterator(); i.hasNext(); )
    {
      ...
      final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab tab = tabs.get(component);
       ...
       */
      org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab selectedTabInfo = null;
      if (selected != null)
      {
  ...
  {
    fireEvent(new org.novaforge.forge.ui.portal.client.component.TabsheetWithState.SelectedTabChangeEvent(this));
  }
   ...
   */
  public org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab getTab(final com.vaadin.ui.Component c)
  {
    return tabs.get(c);
  }
   ...
   */
  private static void copyTabMetadata(final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab from,
                                      final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab to)
  {
   ...
   */
  public void removeTab(final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab tab)
  {
   ...
   */
  public org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab addTab(final com.vaadin.ui.Component c,
   ...
   * @return the created {@link Tab}
   */
  public org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab addTab(final com.vaadin.ui.Component tabComponent,
                                                                                     final String caption,
                                                                                     final com.vaadin.server.Resource icon,
                                                                                     final int position)
  {
    ...
    {
      final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab tab = tabs.get(tabComponent);
    ...
    else
    {
      ...
      final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.TabSheetTabImpl tab = new org.novaforge.forge.ui.portal.client.component.TabsheetWithState.TabSheetTabImpl(keyMapper
                                                                                                                                                                                            .key(tabComponent),
                                                                                                                                                                                        caption,
                                                                                                                                                                                        icon);
   ...
   * @return the created {@link Tab}
   */
  public org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab addTab(final com.vaadin.ui.Component component,
                                                                                     final int position)
  {
    org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab result = tabs.get(component);
  ...
  public void moveComponentsFrom(final com.vaadin.ui.ComponentContainer source)
  {
    for (final java.util.Iterator<com.vaadin.ui.Component> i = source.getComponentIterator(); i.hasNext(); )
    {
      ...
      String iconAltText = "";
      if (org.novaforge.forge.ui.portal.client.component.TabsheetWithState.class.isAssignableFrom(source.getClass()))
      {
        final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab tab = ((org.novaforge.forge.ui.portal.client.component.TabsheetWithState) source)
                                                                                             .getTab(c);
      ...
      final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab tab = addTab(c, caption, icon);
  ...
  public void removeComponent(final com.vaadin.ui.Component component)
  {
    if ((component != null) && components.contains(component))
    {
      ...
      final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab removedTab = tabs.remove(component);

      getState().tabs
          .remove(((org.novaforge.forge.ui.portal.client.component.TabsheetWithState.TabSheetTabImpl) removedTab)
                      .getTabState());
   ...
   * @param tab
   */
  public void setSelectedTab(final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab tab)
  {
    if (tab != null)
    {
   ...
   * bounds.
   */
  public org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab getTab(final int position)
  {
  ...
  public void replaceComponent(final com.vaadin.ui.Component oldComponent, final com.vaadin.ui.Component newComponent)
  {
    ...
    org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab       newTab = tabs.get(newComponent);
    final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab oldTab = tabs.get(oldComponent);
    ...
    else
    {
      ...
      final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab tmp = new org.novaforge.forge.ui.portal.client.component.TabsheetWithState.TabSheetTabImpl(null,
                                                                                                                                                                            null,
                                                                                                                                                                            null);
   ...
   */
  @Deprecated
  public void addListener(final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.SelectedTabChangeListener listener)
  {
   ...
   */
  public void addSelectedTabChangeListener(final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.SelectedTabChangeListener listener)
  {
    addListener(org.novaforge.forge.ui.portal.client.component.TabsheetWithState.SelectedTabChangeEvent.class, listener,
   ...
   */
  @Deprecated
  public void removeListener(final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.SelectedTabChangeListener listener)
  {
   ...
   */
  public void removeSelectedTabChangeListener(final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.SelectedTabChangeListener listener)
  {
    removeListener(org.novaforge.forge.ui.portal.client.component.TabsheetWithState.SelectedTabChangeEvent.class,
   ...
   */
  public void setTabPosition(final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab tab,
                             final int position)
  {
    ...
    getState().tabs.add(position,
                        ((org.novaforge.forge.ui.portal.client.component.TabsheetWithState.TabSheetTabImpl) tab)
                            .getTabState());
  }
   ...
   * @return
   */
  public int getTabPosition(final org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab tab)
  {
  ...
  @Override
  protected com.vaadin.shared.ui.tabsheet.TabsheetState getState()
  {
    return (com.vaadin.shared.ui.tabsheet.TabsheetState) super.getState();
  }

  @Override
  protected com.vaadin.shared.ui.tabsheet.TabsheetState getState(final boolean markAsDirty)
  {
    return (com.vaadin.shared.ui.tabsheet.TabsheetState) super.getState(markAsDirty);
  }
  ...
  public interface SelectedTabChangeListener extends java.io.Serializable
  {
     ...
     */
    void selectedTabChange(org.novaforge.forge.ui.portal.client.component.TabsheetWithState.SelectedTabChangeEvent event);
  }
   ...
   * to remove the tab from the TabsheetWithState.
   *
  ...
  public interface CloseHandler extends java.io.Serializable
  {
     ...
     *
     * @param tabsheet
     *     the TabsheetWithState to which the tab belongs to
     * @param tabContent
     *     the component that corresponds to the tab whose close
     *     button was clicked
     */
    void onTabClose(final org.novaforge.forge.ui.portal.client.component.TabsheetWithState tabsheet,
  ...
  public static class SelectedTabChangeEvent extends com.vaadin.ui.Component.Event
  {
     ...
     */
    public org.novaforge.forge.ui.portal.client.component.TabsheetWithState getTabSheet()
    {
      return (org.novaforge.forge.ui.portal.client.component.TabsheetWithState) getSource();
    }
  }

  /**
   * Client to server RPC implementation for TabsheetWithState.
   *
   * @since 7.2
   */
  protected class TabsheetServerRpcImpl implements com.vaadin.shared.ui.tabsheet.TabsheetServerRpc
  {
    ...
    @Override
    public void closeTab(final String key)
    {
      final com.vaadin.ui.Component tab = keyMapper.get(key);
      if (tab != null)
      {
        closeHandler.onTabClose(org.novaforge.forge.ui.portal.client.component.TabsheetWithState.this, tab);
      }
    }
  }
   ...
   */
  public class TabSheetTabImpl implements org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab
  {

    private final com.vaadin.shared.ui.tabsheet.TabState tabState;
    ...
    {
      tabState = new com.vaadin.shared.ui.tabsheet.TabState();
    ...
    {
      for (final java.util.Map.Entry<com.vaadin.ui.Component, org.novaforge.forge.ui.portal.client.component.TabsheetWithState.Tab> entry : tabs.entrySet())
      {
  ...
  @Override
  public void addBlurListener(final FieldEvents.BlurListener listener)
  {
  ...
  @Override
  @Deprecated
  public void addListener(final FieldEvents.BlurListener listener)
  {
    addBlurListener(listener);
  }

  @Override
  public void removeBlurListener(final FieldEvents.BlurListener listener)
  {
    removeListener(FieldEvents.BlurEvent.EVENT_ID, FieldEvents.BlurEvent.class,
                   listener);
  }
  ...
  @Override
  @Deprecated
  public void removeListener(final FieldEvents.BlurListener listener)
  {
    removeBlurListener(listener);
  }

  @Override
  public void addFocusListener(final FieldEvents.FocusListener listener)
  {
  ...
  @Override
  @Deprecated
  public void addListener(final FieldEvents.FocusListener listener)
  {
    addFocusListener(listener);
  }

  @Override
  public void removeFocusListener(final FieldEvents.FocusListener listener)
  {
    removeListener(FieldEvents.FocusEvent.EVENT_ID, FieldEvents.FocusEvent.class,
                   listener);
  }
  ...
  @Override
  @Deprecated
  public void removeListener(final FieldEvents.FocusListener listener)
  {
