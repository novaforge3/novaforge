 ...
 */
public class OpenPluginViewEvent implements PortalEvent
{
   ...
   *          the plugin uuid
   * @param pToolUUID
   *          the instance id concerned
   */
  public OpenPluginViewEvent(final String pView, final String pPluginUUID, final String pToolUUID)
  {
    view = pView;
