 ...
 */
public class PortalModuleUnRegisteredEvent implements PortalEvent
{
  /**
   ...
   *          the module id
   */
  public PortalModuleUnRegisteredEvent(final String pPortalModuleId)
  {
    portalId = pPortalModuleId;
  }
   ...
   * @return the id
   */
  public String getPortalModuleId()
  {
    return portalId;
  }
}
