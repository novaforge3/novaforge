...
/**
 * This event is sent when a presenter wants to open an external application
 * 
 * @author Guillaume Lamirand
 */
public class OpenExternalAppEvent implements PortalEvent
{
  /**
   * Source application
   */
   ...
   */
  public OpenExternalAppEvent(final PortalApplication pApp)
  {
    app = pApp;
  }
