 ...
 * @author BILET-JC
 */
public class DistributionEntryPoint implements EntryPoint
{

  /**
   * Create a remote service proxy to talk to the server-side Greeting service.
   */
  private final static DistributionServiceAsync distributionService = GWT.create(DistributionService.class);
  ...
  /**
   * Return the {@link DistributionServiceAsync} service
   *
   * @return the DistributionServiceAsync service
   */
  public static DistributionServiceAsync getServiceAsync()
  {
