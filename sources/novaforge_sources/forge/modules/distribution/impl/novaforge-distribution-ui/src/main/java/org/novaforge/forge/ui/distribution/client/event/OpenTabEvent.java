...
public class OpenTabEvent extends GwtEvent<OpenTabEventHandler>
{
   ...
   public OpenTabEvent(int pTabIndex)
   {
      tabIndex = pTabIndex;
   }

   @Override
   public com.google.gwt.event.shared.GwtEvent.Type<OpenTabEventHandler> getAssociatedType()
   {
      return TYPE;
   }
   ...
   {
      void OpenTab(OpenTabEvent event);
   }
