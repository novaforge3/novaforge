...
public interface ForgeDAO
{
	...
	Forge findById(UUID forgeId) throws NoResultException;

	Forge save(Forge forge);

	void delete(UUID forgeId);

	List<Forge> findByLevel(int level);

	Forge update(Forge pForge);
