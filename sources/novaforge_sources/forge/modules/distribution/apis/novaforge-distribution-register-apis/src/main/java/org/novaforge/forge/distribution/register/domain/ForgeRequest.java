 ...
 * @date 3 janv. 2012
 */
public interface ForgeRequest extends Serializable
{

   UUID getForgeRequestId();

   void setForgeRequestId(UUID forgeRequestId);
   ...
   Forge getDestinationForge();

   void setDestinationForge(Forge destinationForge);

   Forge getSourceForge();

   void setSourceForge(Forge sourceForge);
