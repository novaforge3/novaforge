 ...
 * @author rols-p
 */
public interface PluginDataClient
{
  /**
   * @param pluginUUID
   * @return a PluginDataService corresponding to the plugin UUID.
   * @throws ReferenceServiceException
   *           if service can not be found.
   */
  PluginDataService getPluginDataService(String pluginUUID) throws ReferenceServiceException;
}
