...
{
  private List<SynchronizationResult> synchronizationResults = new ArrayList<SynchronizationResult>();

  /**
   * @return the synchronizationResults
   */
  @Historizable(label = "synchronizationResults")
  ...
  /**
   * @param synchronizationResults
   *          the synchronizationResults to set
   */
  public void setSynchronizationResults(final List<SynchronizationResult> synchronizationResults)
  {
  ...
  {
    return "DiffusionResultDTO [synchronizationResults=" + synchronizationResults + "]";
  }
