...
public class RootNode
{
  private String          uri;
  private String          name;
  private List<SpaceNode> childs = new ArrayList<SpaceNode>();
   ...
   * @param pName
   */
  public RootNode(final String pUri, final String pName)
  {
    uri = pUri;
    name = pName;
  }
   ...
   *          the childs to set
   */
  public void setSpaces(final List<SpaceNode> pChilds)
  {
    childs = pChilds;
  }
