...
package org.novaforge.forge.distribution.reporting.client;
 ...
 */
public interface ForgeReportingClient
{
   List<ForgeViewDTO> getForgeView(UUID forgeId) throws ForgeReportingException;

   List<ProfilViewDTO> getProfilView(UUID forgeId) throws ForgeReportingException;

   List<OrganizationViewDTO> getOrganizationView(UUID forgeId) throws ForgeReportingException;

   void storeForgeData(final UUID forgeId, final List<ProjectDTO> projects, final List<UserDTO> users)
