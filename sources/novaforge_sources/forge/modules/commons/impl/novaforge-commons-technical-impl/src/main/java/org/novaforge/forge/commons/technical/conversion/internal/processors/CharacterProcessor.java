 ...
 * @date Mar 11, 2010
 */
public class CharacterProcessor extends CellProcessorAdaptor
{
  ...
  public Object execute(final Object pValue, final CsvContext pContext)
  {
    ...
    if ((!(pValue instanceof Character)) && (!(pValue instanceof String)))
    {
      throw new SuperCsvConstraintViolationException("the value '" + pValue
          + "' is not of required String or Character types", pContext, this);
    }
    ...
    try
    {
      ...
      else
      {
        ...
        {
          result = Character.valueOf(strValue.charAt(0));
        }
      }
    }
    catch (final Exception e)
    {
      throw new SuperCsvConstraintViolationException("an error occured during Character conversion",
          pContext, this);
    }
