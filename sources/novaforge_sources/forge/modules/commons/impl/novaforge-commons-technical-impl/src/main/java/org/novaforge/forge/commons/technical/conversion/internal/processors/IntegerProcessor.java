 ...
 * @date Mar 11, 2010
 */
public class IntegerProcessor extends CellProcessorAdaptor
{
  ...
  public Object execute(final Object pValue, final CsvContext pContext)
  {
    ...
    if ((!(pValue instanceof Integer)) && (!(pValue instanceof String)))
    {
      throw new SuperCsvConstraintViolationException("the value '" + pValue
          + "' is not of required String or Integer types", pContext, this);
    }
    ...
    {
      throw new SuperCsvConstraintViolationException("an error occured during Integer conversion", pContext,
          this);
    }
