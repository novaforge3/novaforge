 ...
 * @date Mar 11, 2010
 */
public class LongProcessor extends CellProcessorAdaptor
{
  ...
  public Object execute(final Object pValue, final CsvContext pContext)
  {
    ...
    if ((!(pValue instanceof Long)) && (!(pValue instanceof String)))
    {
      throw new SuperCsvConstraintViolationException("the value '" + pValue
          + "' is not of required String or Long types", pContext, this);
    }
    ...
    {
      throw new SuperCsvConstraintViolationException("an error occured during Long conversion", pContext,
          this);
    }
