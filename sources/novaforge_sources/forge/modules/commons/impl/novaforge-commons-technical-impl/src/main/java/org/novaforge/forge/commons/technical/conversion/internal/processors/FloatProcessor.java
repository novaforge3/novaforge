 ...
 * @date Mar 11, 2010
 */
public class FloatProcessor extends CellProcessorAdaptor
{
  ...
  public Object execute(final Object pValue, final CsvContext pContext)
  {
    ...
    if ((!(pValue instanceof Float)) && (!(pValue instanceof String)))
    {
      throw new SuperCsvConstraintViolationException("the value '" + pValue
          + "' is not of required String or Float types", pContext, this);
    }
    ...
    {
      throw new SuperCsvConstraintViolationException("an error occured during Float conversion", pContext,
          this);
    }
