 ...
 * @date Mar 11, 2010
 */
public class ByteProcessor extends CellProcessorAdaptor
{
  ...
  public Object execute(final Object pValue, final CsvContext pContext)
  {
    ...
    if ((!(pValue instanceof Byte)) && (!(pValue instanceof String)))
    {
      throw new SuperCsvConstraintViolationException("the value '" + pValue
          + "' is not of required String or Byte types", pContext, this);
    }
    ...
    {
      throw new SuperCsvConstraintViolationException("an error occured during Byte conversion", pContext,
          this);
    }
