 ...
 */
public interface AdminArticleView extends ComponentContainer
{

  /**
   * Refresh the internationalized label with given locale
   * 
   * @param pLocale
   *          the locale to use
   */
  ...
  /**
   * Get the create article button
   * 
   * @return the button
   */
  Button getCreateArticleButton();
