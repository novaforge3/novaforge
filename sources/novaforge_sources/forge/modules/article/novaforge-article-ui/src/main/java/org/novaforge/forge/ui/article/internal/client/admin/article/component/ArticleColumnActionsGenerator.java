 ...
 */
public class ArticleColumnActionsGenerator implements ColumnGenerator
{
  ...
  private AdminArticlePresenter presenter;
   ...
   */
  public ArticleColumnActionsGenerator(final AdminArticlePresenter pPresenter)
  {
    super();
  ...
  public Object generateCell(Table source, Object itemId, Object columnId)
  {
    ...
    if (isPublished)
    {
      publishArticleIcon.setSource(new ThemeResource(NovaForgeResources.ICON_NEWS_UNPUBLISH));
    ...
    {
      publishArticleIcon.setSource(new ThemeResource(NovaForgeResources.ICON_NEWS_PUBLISH));
      publishArticleIcon.setDescription(ArticleModule.getPortalMessages().getMessage(locale,
    ...
    publishArticleIcon.addClickListener(new MouseEvents.ClickListener()
    {
       ...
       * 
       */
      private static final long serialVersionUID = 5847850538917185555L;

      @Override
      public void click(final com.vaadin.event.MouseEvents.ClickEvent event)
      {
        presenter.setArticlePublished(articleID, !isPublished);
      }
    });
    // ACTION edit profile
    final Embedded editArticleIcon = new Embedded(null, new ThemeResource(NovaForgeResources.ICON_NEWS_EDIT));
    ...
    editArticleIcon.addClickListener(new MouseEvents.ClickListener()
    {
       ...
       * 
       */
      private static final long serialVersionUID = -7642939372215474067L;

      @Override
      public void click(final com.vaadin.event.MouseEvents.ClickEvent event)
      {
        presenter.editArticle(articleID);
      }
    });

    // ACTION delete user
    final Embedded deleteDeleteIcon = new Embedded(null,
        new ThemeResource(NovaForgeResources.ICON_NEWS_TRASH));
    ...
    deleteDeleteIcon.addClickListener(new MouseEvents.ClickListener()
    {
       ...
       * 
       */
      private static final long serialVersionUID = -3971821392691101196L;
