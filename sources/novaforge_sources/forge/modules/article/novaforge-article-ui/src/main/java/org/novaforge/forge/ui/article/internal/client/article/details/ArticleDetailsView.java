 ...
 */
public interface ArticleDetailsView extends ComponentContainer
{
  ...
  /**
   * Get the News SortText Label
   * 
   * @return the label
   */
  Label getNewsShortText();

  /**
   * Get the News Title Label
   * 
   * @return the label
   */
  Label getNewsTitle();
  ...
  /**
   * Set the ArticleCAtegory
   * 
   * @param pCategory
   *          , the ArticleCategory to set
   */
  void setCategory(ArticleCategory pCategory);

  /**
   * Get the News Date Label
   * 
   * @return the label
   */
  Label getNewsDate();
