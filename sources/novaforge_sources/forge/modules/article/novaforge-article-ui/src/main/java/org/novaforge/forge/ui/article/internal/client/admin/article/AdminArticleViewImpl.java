 ...
 */
public class AdminArticleViewImpl extends VerticalLayout implements AdminArticleView
{
   ...
   */
  private final Button      createArticleButton = new Button();
  /**
  ...
  private Component initHeader()
  {
    ...
    createArticleButton.setStyleName(NovaForge.BUTTON_PRIMARY);
    createArticleButton.setIcon(new ThemeResource(NovaForgeResources.ICON_PLUS));
    headerLayout.addComponent(createArticleButton);
   ...
   * 
   * @return the filters layout component
   */
  ...
  /**
   * Initialize the article list layout
   * 
  ...
  private Component initList()
  {
    ...
    articleTable.setPageLength(10);
    articleTable.setWidth(100, Unit.PERCENTAGE);
    listLayout.addComponent(articleTable);
    return listLayout;
  }
  ...
  {
    createArticleButton.setCaption(ArticleModule.getPortalMessages().getMessage(pLocale,
