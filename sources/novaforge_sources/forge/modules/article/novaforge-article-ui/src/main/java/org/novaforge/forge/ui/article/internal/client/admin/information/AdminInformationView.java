 ...
 */
public interface AdminInformationView extends ComponentContainer
{
  ...
  /**
   * Bind The view with the given Information
   * 
   * @param pInformation
   *          to bind
   */
  void bindToInformation(Article pInformation);

  /**
   * Get the Form Binders list
   * 
   * @return the list of FieldGroup
   */
