 ...
 */
public class NoSettingsPresenter extends AbstractWidgetPresenter implements Serializable,
    WidgetDataComponent, WidgetAdminComponent
{
   ...
   */
  private final NoSettingsView view;
   ...
   */
  public NoSettingsPresenter(final WidgetContext pWidgetContext, final NoSettingsView pView)
  {
