 ...
 */
package org.novaforge.forge.dashboard.internal.widget.nosettings.module;

import org.apache.commons.io.IOUtils;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.novaforge.forge.dashboard.internal.widget.nosettings.client.NoSettingsPresenter;
import org.novaforge.forge.dashboard.internal.widget.nosettings.client.NoSettingsView;
import org.novaforge.forge.dashboard.internal.widget.nosettings.client.NoSettingsViewImpl;
 ...
 */
public class NoSettingsModule implements WidgetModule
{

  /**
   * Logger component
   */
  private static final Log LOGGER = LogFactory.getLog(NoSettingsModule.class);
  /**
  ...
  {
    return WidgetModule.NO_SETTINGS_KEY;
  }
  ...
  {
    return DATASOURCE_FACTORY.buildOptions(true, true, true, true);
  }
  ...
  {
    final NoSettingsView      view      = new NoSettingsViewImpl();
    return new NoSettingsPresenter(pWidgetContext, view);
  }
