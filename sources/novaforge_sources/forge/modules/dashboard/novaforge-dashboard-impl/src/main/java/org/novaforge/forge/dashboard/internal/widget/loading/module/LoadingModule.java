 ...
 */
package org.novaforge.forge.dashboard.internal.widget.loading.module;

import org.apache.commons.io.IOUtils;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.novaforge.forge.dashboard.internal.widget.loading.client.LoadingPresenter;
import org.novaforge.forge.dashboard.internal.widget.loading.client.LoadingView;
import org.novaforge.forge.dashboard.internal.widget.loading.client.LoadingViewImpl;
 ...
 */
public class LoadingModule implements WidgetModule
{

  /**
   * Logger component
   */
  private static final Log LOGGER = LogFactory.getLog(LoadingModule.class);
  /**
  ...
  {
    return WidgetModule.LOADING_KEY;
  }
  ...
  {
    final LoadingView      view      = new LoadingViewImpl();
    return new LoadingPresenter(pWidgetContext, view);
  }
