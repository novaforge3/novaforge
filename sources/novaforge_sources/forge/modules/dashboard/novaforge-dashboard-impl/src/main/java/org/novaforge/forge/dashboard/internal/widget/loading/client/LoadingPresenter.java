 ...
 */
public class LoadingPresenter extends AbstractWidgetPresenter implements Serializable,
    WidgetDataComponent, WidgetAdminComponent
{
   ...
   */
  public LoadingPresenter(final WidgetContext pWidgetContext, final LoadingView pView)
  {
