 ...
 * Should be used by each presenter in a {@link WidgetModule}
 * 
 * @author Guillaume Lamirand
 */
public abstract class AbstractWidgetPresenter extends AbstractWidgetEventHandler implements
    LocaleChangedListener
{
   ...
   *          the widgetContext
   */
  public AbstractWidgetPresenter(final WidgetContext pWidgetContext)
  {
    super(pWidgetContext);
    currentLocale = pWidgetContext.getLocale();
  }
