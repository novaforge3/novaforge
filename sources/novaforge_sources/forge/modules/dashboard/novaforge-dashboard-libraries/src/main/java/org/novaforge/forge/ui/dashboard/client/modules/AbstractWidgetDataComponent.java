 ...
 */
public abstract class AbstractWidgetDataComponent extends AbstractWidgetComponent implements
    WidgetDataComponent
{
   ...
   *          the initial context
   */
  public AbstractWidgetDataComponent(final WidgetContext pWidgetContext)
  {
