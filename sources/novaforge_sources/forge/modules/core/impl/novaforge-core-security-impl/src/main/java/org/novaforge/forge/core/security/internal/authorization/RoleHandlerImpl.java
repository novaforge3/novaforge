...
public class RoleHandlerImpl implements RoleHandler
{
  ...
  /**
   * This is used to separate project id and role name
   */
   ...
   */
  @Override
  public String buildCacheName(final String pProjectId, final String pRoleName)
  {
    return pProjectId + CACHE_SEPARATOR + pRoleName;
  }
