...
public class AuthorizationResourceImpl implements AuthorizationResource
{
   ...
   * @param pActions
   */
  public AuthorizationResourceImpl(final Class<?> pClazz, final PermissionAction... pActions)
  {
    this(pClazz, Arrays.asList(pActions));
  }
   ...
   * @param pActions
   */
  public AuthorizationResourceImpl(final Class<?> pClazz, final List<PermissionAction> pActions)
  {
    clazz = pClazz;
    actions = pActions;
  }
