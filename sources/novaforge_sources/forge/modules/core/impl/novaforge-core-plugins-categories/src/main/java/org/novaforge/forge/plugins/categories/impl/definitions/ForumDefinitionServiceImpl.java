 ...
 */
public class ForumDefinitionServiceImpl extends AbstractDefinitionService implements
    CategoryDefinitionService
{
   ...
   */
  private static final String         PROPERTY_FILE         = "categories.forum.definition";
  /**
  ...
  {
    return ForumCategoryService.class;
  }
