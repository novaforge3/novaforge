...
import org.novaforge.forge.core.plugins.categories.survey.SurveyCategoryService;
 ...
 */
public class SurveyDefinitionServiceImpl extends AbstractDefinitionService implements
    CategoryDefinitionService
{
  /**
   * The name of the property file used
   */
  private static final String         PROPERTY_FILE         = "categories.survey.definition";
  /**
  ...
  {
    return SurveyCategoryService.class;
  }
