...
import org.novaforge.forge.core.plugins.categories.ard.ARDCategoryService;
 ...
 * @author sbenoist
 */
public class ARDDefinitionServiceImpl extends AbstractDefinitionService implements CategoryDefinitionService
{

  /**
   * The name of the property file used
   */
  private static final String         PROPERTY_FILE         = "categories.ard.definition";
  /**
  ...
  {
    return ARDCategoryService.class;
  }
