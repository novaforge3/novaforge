...
import org.novaforge.forge.core.plugins.categories.ci.CICategoryService;
 ...
 */
public class CIDefinitionServiceImpl extends AbstractDefinitionService implements CategoryDefinitionService
{
  /**
   * The name of the property file used
   */
  private static final String         PROPERTY_FILE         = "categories.ci.definition";
  /**
  ...
  {
    return CICategoryService.class;
  }
