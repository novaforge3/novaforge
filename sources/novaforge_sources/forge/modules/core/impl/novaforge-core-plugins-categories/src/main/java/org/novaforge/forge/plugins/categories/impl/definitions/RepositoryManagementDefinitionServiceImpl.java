 ...
 */
public class RepositoryManagementDefinitionServiceImpl extends AbstractDefinitionService implements
    CategoryDefinitionService
{
   ...
   */
  private static final String         PROPERTY_FILE         = "categories.repositorymanagement.definition";
  /**
  ...
  {
    return Category.REPOSITORYMANAGEMENT;
  }
  ...
  {
    return RepositoryManagementCategoryService.class;
  }
