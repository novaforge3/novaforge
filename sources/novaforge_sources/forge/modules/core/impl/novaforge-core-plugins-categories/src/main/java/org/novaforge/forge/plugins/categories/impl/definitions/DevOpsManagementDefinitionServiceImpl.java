...
import org.novaforge.forge.core.plugins.categories.devopsmanagement.DevOpsManagementCategoryService;
 ...
 * @author dekimpea
 */
public class DevOpsManagementDefinitionServiceImpl extends AbstractDefinitionService implements CategoryDefinitionService
{
  /**
   * The name of the property file used
   */
  private static final String         PROPERTY_FILE         = "categories.devopsmanagement.definition";
  /**
  ...
  {
    return Category.DEVOPSMANAGEMENT;
  }
  ...
  {
    return DevOpsManagementCategoryService.class;
  }
