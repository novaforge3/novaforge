 ...
 */
public class SCMDefinitionServiceImpl extends AbstractDefinitionService implements CategoryDefinitionService
{
  /**
   * The name of the property file used
   */
  private static final String         PROPERTY_FILE         = "categories.scm.definition";
  /**
  ...
  private void buildAssociations()
  {
    ...
    for (final SCMReply reply : SCMReply.values())
    {
  ...
  {
    return SCMCategoryService.class;
  }
