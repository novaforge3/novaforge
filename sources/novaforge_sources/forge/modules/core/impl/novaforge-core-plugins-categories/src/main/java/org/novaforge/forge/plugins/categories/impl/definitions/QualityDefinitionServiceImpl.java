 ...
 */
public class QualityDefinitionServiceImpl extends AbstractDefinitionService implements
    CategoryDefinitionService
{
   ...
   */
  private static final String         PROPERTY_FILE         = "categories.quality.definition";
  /**
  ...
  {
    return QualityCategoryService.class;
  }
