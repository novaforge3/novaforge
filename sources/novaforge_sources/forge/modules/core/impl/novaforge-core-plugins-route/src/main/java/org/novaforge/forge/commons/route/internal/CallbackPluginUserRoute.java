 ...
 * @author sbenoist
 */
public class CallbackPluginUserRoute extends AbstractCallbackPluginRoute
{
  /**
   * {@inheritDoc}
   */
  ...
  {
    return RouteUtil.FORGE_CALLBACK_USER_ROUTE_NAME;
  }
  ...
  {
    return EventType.PROPAGATION_FOR_USER;
  }
