 ...
 * @author sbenoist
 */
public class CallbackPluginDataRoute extends AbstractCallbackPluginRoute
{
  ...
  {
    return RouteUtil.FORGE_CALLBACK_DATA_QUEUE;
  }
  ...
  {
    return RouteUtil.FORGE_CALLBACK_DATA_ROUTE_NAME;
  }
  ...
  {
    return EventType.PROPAGATION_DATA;
  }
