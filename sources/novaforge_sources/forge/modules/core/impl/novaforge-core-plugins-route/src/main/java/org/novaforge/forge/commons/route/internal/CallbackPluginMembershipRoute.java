 ...
 * @author sbenoist
 */
public class CallbackPluginMembershipRoute extends AbstractCallbackPluginRoute
{
  /**
   * {@inheritDoc}
   */
  ...
  {
    return RouteUtil.FORGE_CALLBACK_MEMBERSHIP_ROUTE_NAME;
  }
  ...
  {
    return EventType.PROPAGATION_FOR_MEMBERSHIP;
  }
