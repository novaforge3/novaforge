 ...
 * @author sbenoist
 */
public class CallbackPluginRolesMappingRoute extends AbstractCallbackPluginRoute
{
  /**
   * {@inheritDoc}
   */
  ...
  {
    return RouteUtil.FORGE_CALLBACK_ROLES_MAPPING_ROUTE_NAME;
  }
  ...
  {
    return EventType.PROPAGATION_FOR_ROLES_MAPPING;
  }
