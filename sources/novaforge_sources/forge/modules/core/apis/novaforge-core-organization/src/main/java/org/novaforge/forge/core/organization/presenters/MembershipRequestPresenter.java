 ...
 * @author lamirang
 */
public interface MembershipRequestPresenter
{
   ...
   * @param pMessage
   *          represents the message used to inform project administrator
   * @throws ProjectServiceException
   */
  void createRequest(final String pProjectId, final String pMessage, final boolean pSendMail)
      throws ProjectServiceException;
   ...
   * @param pRoles
   *          represents the set of roles used for the membership. This have to contain at least one element
   * @param pDefaultRole
   *          represents the prioritary role can be null or empty
   * @throws ProjectServiceException
   */
  void validateRequest(final String pProjectId, final String pUserLogin, final Set<String> pRoles,
      String pDefaultRole, final boolean pSendMail) throws ProjectServiceException;
