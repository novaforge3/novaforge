...
public interface CompositionService
{
   ...
   */
  Composition createComposition(final String pProjectId, final Composition pComposition,
   ...
   * @param pProject
   *          represents the project id
   * @return the list of application composition entity existing
   * @throws CompositionServiceException
   */
  ...
  List<Composition> getCompositionFromSource(String pProjectId, String pSourceInstance,
      CompositionType pSourceType, String pSourceName) throws CompositionServiceException;
   ...
   * @throws CompositionServiceException
   */
  List<Composition> getCompositionFromSource(String pSourceInstance) throws CompositionServiceException;
