...
/**
 * This interface describes a service which will mange application request
 * 
 * @author Guillaume Lamirand
 */
public interface ProjectApplicationRequestPresenter
{
   ...
   * @throws ApplicationServiceException
   */
  void handleRequest(final ProjectApplicationRequest pProjectApplicationRequest, final UUID pToolInstanceUUID)
      throws ApplicationServiceException;

  /**
   * This method allows to handle the oldest request by link the application instance ID to the tool instance
   * name. Therefore the application is propagated to the plugin and the request is deleted.
   * 
   * @param pToolInstanceUUID
   * @param pPluginUUID
   * @throws ApplicationServiceException
