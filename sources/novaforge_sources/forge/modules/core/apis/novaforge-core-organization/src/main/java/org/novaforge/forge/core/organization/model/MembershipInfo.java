...
/**
 * This describes a relationship between a project and an actor instantiated by a defined role
 * 
 * @author Guillaume Lamirand
 */
public interface MembershipInfo
{
  /**
  ...
  /**
   * This method returns role of the membership
   * 
   * @return #@link ProjectRole}
   */
  ProjectRole getRole();
