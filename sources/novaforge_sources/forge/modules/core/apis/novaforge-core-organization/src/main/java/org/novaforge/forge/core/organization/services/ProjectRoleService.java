...
public interface ProjectRoleService
{
   ...
   * @throws ProjectServiceException
   */
  void updateRole(final String pOldName, final Role pRole, final String pProjectId, final String pAuthor)
      throws ProjectServiceException;
  ...
  ProjectRole changeOrder(final String pProjectId, final String pRoleName, final boolean pIncrease,
      final String pAuthor) throws ProjectServiceException;
