...
public interface GroupPresenter
{
   ...
   * @throws GroupServiceException
   */
  void updateGroup(final String pProjectId, final String pOldName, final Group pGroup)
      throws GroupServiceException;
   ...
   * @throws GroupServiceException
   */
  void deleteGroup(final String pProjectId, final UUID pGroupUUID) throws GroupServiceException;
