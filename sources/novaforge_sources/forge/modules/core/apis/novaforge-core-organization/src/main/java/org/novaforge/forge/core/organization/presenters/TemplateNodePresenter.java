 ...
 * @author lamirang
 */
public interface TemplateNodePresenter
{
   ...
   * @throws TemplateTemplateServiceException
   */
   ...
   * @throws TemplateServiceException
   */
  void removeApplication(String pTemplateId, String parentNodeUri, String applicationUri)
      throws TemplateServiceException;
   ...
   * @throws TemplateTemplateServiceException
   */
  List<TemplateApplication> getAllSpaceApplications(final String pSpaceNodeUri, final String pTemplateId)
      throws TemplateServiceException;
   ...
   * @throws TemplateServiceException
   */
  void removeSpace(final String pTemplateId, String spaceNodeUri) throws TemplateServiceException;
