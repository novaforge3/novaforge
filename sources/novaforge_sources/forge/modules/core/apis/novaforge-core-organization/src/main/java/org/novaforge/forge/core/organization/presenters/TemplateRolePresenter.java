 ...
 * @author lamirang
 */
public interface TemplateRolePresenter
{
   ...
   */
  void createRole(Role role, String pTemplateId) throws TemplateServiceException;

  /**
   * This method allows to create a role with system type
   * 
   * @param role
   * @param pTemplateId
   * @param author
   ...
   * @throws TemplateServiceException
   */
  void createSystemRole(Role role, String pTemplateId) throws TemplateServiceException;
   ...
   * @throws TemplateServiceException
   */
  void deleteRole(String roleName, String pTemplateId) throws TemplateServiceException;
