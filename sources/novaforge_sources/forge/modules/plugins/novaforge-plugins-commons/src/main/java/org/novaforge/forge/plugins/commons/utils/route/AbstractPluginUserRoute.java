...
import org.novaforge.forge.plugins.commons.utils.route.processors.UserProcessor;

/**
 * @author sbenoist
 */
public abstract class AbstractPluginUserRoute extends AbstractPluginRoute
{
	...
	{
		return new UserProcessor(getPluginQueueName(), pluginUserService);
	}
	...
	{
		return RouteUtil.FORGE_CALLBACK_USER_QUEUE;
	}
