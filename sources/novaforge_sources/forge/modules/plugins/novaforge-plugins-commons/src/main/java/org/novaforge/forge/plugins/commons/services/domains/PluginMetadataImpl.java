...
public class PluginMetadataImpl implements PluginMetadata
{
	 ...
	 * 
	 */
	private static final long      serialVersionUID = 241423449941013696L;
	...
	public PluginMetadataImpl(final UUID pUuid, final String pDescription, final String pType, final String pCategory,
														final PluginQueues pPluginQueues, final List<PluginView> pPluginView, final PluginStatus pStatus, final boolean pAvailability, final String pVersion)
	{
		uuid = pUuid;
