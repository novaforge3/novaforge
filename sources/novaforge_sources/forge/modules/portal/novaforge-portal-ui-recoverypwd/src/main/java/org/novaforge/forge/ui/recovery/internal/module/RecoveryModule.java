 ...
 */
package org.novaforge.forge.ui.recovery.internal.module;
...
import org.novaforge.forge.ui.recovery.internal.client.RecoveryPwdPresenter;
import org.novaforge.forge.ui.recovery.internal.client.RecoveryPwdView;
import org.novaforge.forge.ui.recovery.internal.client.RecoveryPwdViewImpl;

/**
 * This module concernes recovery view. It is used on portal when user wants to get back its password.
 * 
 * @author Guillaume Lamirand
 */
public class RecoveryModule implements PortalModule
{
  ...
  /**
   * Get implementation of {@link UserPresenter}
   *
  ...
  {
    return PortalModuleId.RECOVERY_PWD;
  }
  ...
  public PortalComponent createComponent(final PortalContext pPortalContext)
  {
    ...
    final RecoveryPwdView      view      = new RecoveryPwdViewImpl(sub);
    return new RecoveryPwdPresenter(view, pPortalContext);
  }
}
