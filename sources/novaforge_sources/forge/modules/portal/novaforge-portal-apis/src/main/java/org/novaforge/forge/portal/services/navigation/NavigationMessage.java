...
/**
 * This interface describes message services used for i18n.
 * 
 * @author Guillaume Lamirand
 */
public interface NavigationMessage
{
   ...
   */
  String getNavigationMessage(final String pKey, final Locale pLocale);
