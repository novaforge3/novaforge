 ...
 */
public class NavigationStyleGenerator implements ItemStyleGenerator
{
  ...
  {
    String style = null;
    final Property<?> status = pSource.getContainerProperty(pItemId, TreeItemProperty.STATUS.getPropertyId());
    ...
    if (((availability.getValue() != null) && (availability.getValue() instanceof Boolean) && (!((Boolean) availability
                                                                                                               .getValue())))
        || (((status.getValue() != null) && (status.getValue() instanceof ApplicationStatus) && (ApplicationStatus.CREATE_ON_ERROR
            .equals(status.getValue())))))
    {
      style = NovaForge.LABEL_STRIKE;
                 ...
                 && (!ApplicationStatus.ACTIVE.equals(status.getValue())))
    {
