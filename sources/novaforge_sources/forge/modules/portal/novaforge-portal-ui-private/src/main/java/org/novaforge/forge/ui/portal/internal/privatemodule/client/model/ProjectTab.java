...
/**
 * This class is used to map an project tab element to its references such as :
 * <ol>
 * <li>its {@link Tab} object</li>
 * <li>its {@link ProjectTabPresenter} object</li>
 * </ol>
 *
...
{
  private ProjectTabPresenter projectTabPresenter;
  private Tab                 tab;

  /**
   * Default constructor for internal tabulation
   */
  public ProjectTab(final ProjectTabPresenter pProjectTabPresenter, final Tab pTab)
  {
    super();
