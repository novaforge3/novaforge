 ...
 * @author lamirang
 */
public class ApplicationAddViewImpl extends Composite implements ApplicationAddView
{
	...
	interface ApplicationAddViewImplUiBinder extends UiBinder<Widget, ApplicationAddViewImpl>
	{
	}
}
