 ...
 * @author lamirang
 */
public interface TemplateApplicationAddView extends IsWidget
{
	...
	TextBoxBaseValidation getName();

	ListBox getTypes();

	ListBox getCategories();

	void updateSortHandler();

	ListDataProvider<RoleDTO> getDataProvider();
	 ...
	 * @return
	 */
	HorizontalPanel getWaitingPanel();
