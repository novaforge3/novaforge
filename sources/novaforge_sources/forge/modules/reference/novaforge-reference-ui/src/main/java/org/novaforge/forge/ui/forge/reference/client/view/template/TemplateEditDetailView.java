 ...
 * @author lamirang
 */
public interface TemplateEditDetailView extends IsWidget
{

	TextBoxValidation getTemplateName();

	TextBoxValidation getTemplateId();

	TextAreaValidation getTemplateDescription();
}
