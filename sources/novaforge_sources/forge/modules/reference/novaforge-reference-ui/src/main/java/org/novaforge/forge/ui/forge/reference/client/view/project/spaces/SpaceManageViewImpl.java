 ...
 * @author lamirang
 */
public class SpaceManageViewImpl extends Composite implements SpaceManageView
{
	...
	public SpaceManageViewImpl(final ManagePresenterType pType)
	{
	...
	interface ProjectEditViewImplUiBinder extends UiBinder<Widget, SpaceManageViewImpl>
	{
	}
}
