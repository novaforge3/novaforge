 ...
 * @author lamirang
 */
public class RoleManageViewImpl extends Composite implements RoleManageView
{
	private static RoleManageViewImplUiBinder uiBinder       = GWT.create(RoleManageViewImplUiBinder.class);
	...
	private final GlobalMessage messagesGlobal = (GlobalMessage) GWT.create(GlobalMessage.class);
	@UiField
	...
	Label                     roleNameLabel;
	@UiField
	TextBoxValidation         roleNameValidator;
	@UiField
	Label                     roleDescLabel;
	@UiField
	TextAreaValidation        roleDescValidator;
	...
	public RoleManageViewImpl(final ManagePresenterType pType)
	{
		...
		{
			case CREATE:
				buttonSaveGroup.setText(messagesGlobal.buttonSaveCreate());
				// Initialization of validation popup
				validateDialogBox = new ValidateDialogBox(messages.addValidationMessage());

				break;
			case UPDATE:
				buttonSaveGroup.setText(messagesGlobal.buttonSave());
				// Initialization of validation popup
				validateDialogBox = new ValidateDialogBox(messages.editValidationMessage());

				break;
		}
		buttonCancelGroup.setText(messagesGlobal.buttonCancel());

	}

	@Override
	public TextBoxBaseValidation getRoleName()
	{
		return roleNameValidator;
	}

	@Override
	public TextBoxBaseValidation getRoleDescription()
	{
		return roleDescValidator;
	}
	...
	interface RoleManageViewImplUiBinder extends UiBinder<Widget, RoleManageViewImpl>
	{
	}
}
