...
public enum ErrorEnumeration
{
    ...
    * Application
    */
   ERR_CREATE_SPACE_NAME_ALREADY_EXIST, ERR_CREATE_APP_NAME_ALREADY_EXIST,
    ...
    * Membership requests
    */
   ERR_LOADING_USERS, ERR_LOADING_USER,

   ERR_VALIDATE_USER_SENDING_MAIL_AUTHOR, ERR_CREATE_USER_SENDING_MAIL_ADMINISTRATOR,

   ERR_REJECT_USER_SENDING_MAIL_AUTHOR, ERR_CHANGE_USER_STATUS_STATUS_ALREADY_CHANGED
