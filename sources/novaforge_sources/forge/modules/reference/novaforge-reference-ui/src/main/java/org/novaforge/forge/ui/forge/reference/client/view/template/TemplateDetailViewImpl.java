 ...
 * @author lamirang
 */
public class TemplateDetailViewImpl extends Composite implements TemplateDetailView
{
	...
	@UiField
	Button                            buttonUpdateTemplate;
	@UiField
	Button                            buttonDeleteTemplate;
	@UiField
	Button                            buttonEnableTemplate;
	@UiField
	Button                            buttonDisableTemplate;
	@UiField
	...
	public TemplateDetailViewImpl()
	{
		...
		// Set buttons' text
		buttonUpdateTemplate.setText(templateMessages.buttonUpdate());
		buttonDeleteTemplate.setText(templateMessages.buttonDelete());
		buttonEnableTemplate.setText(templateMessages.buttonEnableTemplate());
		buttonDisableTemplate.setText(templateMessages.buttonDisableTemplate());
		...
		templateStatusLabel.setText(templateMessages.status());
		...
		validateDialogBox = new ValidateDialogBox(templateMessages.deleteValidationMessage());
	...
	{
		return buttonUpdateTemplate;
	}

	@Override
	public Button getEnableButton()
	{
		return buttonEnableTemplate;
	}

	@Override
	public Button getDisableButton()
	{
		return buttonDisableTemplate;
	}

	@Override
	public HasText getTemplateName()
	{
		return templateName;
	}

	@Override
	public HasText getTemplateDescription()
	{
		return templateDesc;
	}

	@Override
	public HasText getTemplateStatus()
	{
	...
	interface TemplateDetailViewImplUiBinder extends UiBinder<Widget, TemplateDetailViewImpl>
	{
	}
