 ...
 * @author lamirang
 */
public interface RoleManageView extends IsWidget
{

	TextBoxBaseValidation getRoleName();

	TextBoxBaseValidation getRoleDescription();

	HasClickHandlers getSaveButton();

	HasClickHandlers getCancelButton();

	HorizontalPanel getRoleLoadingPanel();
