...
public class ColumnDateGenerator implements ColumnGenerator
{
  ...
  public Object generateCell(final com.vaadin.ui.Table pSource, final Object pItemId, final Object pColumnId)
  {
    ...
    final Date createdDate = (Date) item.getItemProperty(CommitItemProperty.DATE.getPropertyId()).getValue();
    if (createdDate != null)
    {
      final SimpleDateFormat formatter = new SimpleDateFormat("EE d MM yy", UI.getCurrent().getLocale());
