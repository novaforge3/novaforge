...
/**
 * This command (launched onto CENTRAL forge) will propagate templates.
 * 
 * @author Marc Blachon
 */
@Command(scope = "distribution", name = "sync-immediate-templates",
description = "launch immediate synchonisation")
public class SyncTemplatesImmediateCommand extends OsgiCommandSupport
{
   ...
   protected Object doExecute() throws Exception
   {
      ...
      System.out.println("Templates has been propagated.");
      return null;
   }
