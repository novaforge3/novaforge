 ...
 * @author Marc Blachon
 */
@Command(scope = "distribution", name = "list-forge-diffusion",
    description = "list target forges for propagation")
public class ListForgeForDiffusionCommand extends OsgiCommandSupport
{
  ...
  protected Object doExecute() throws Exception
  {
    ...
    final Set<TargetForge> forges = diffusionService.getTargetForges();
    ...
    if (forges != null)
    {
      ...
      for (final TargetForge targetForge : forges)
      {
        final List<String> row = table.addRow();
        row.add(targetForge.getLabel());
        table.print();
      }
    }
    else
    {
      System.out.println("No forges found for propagation !");
    }
   ...
   */
  public void setForgeConfigurationService(ForgeConfigurationService pForgeConfigurationService)
  {
