...
/**
 * This command (launched onto CENTRAL forge) will extract reports.
 * 
 * @author Marc Blachon
 */
@Command(scope = "distribution", name = "sync-immediate-report-extraction",
description = "launch immediate synchonisation for report extraction")
public class SyncReportsImmediateCommand extends OsgiCommandSupport
{
   ...
   protected Object doExecute() throws Exception
   {
      ...
      System.out.println("Reporting Extraction has been executed.");
      return null;
   }
