 ...
 * @author Marc Blachon
 */
@Command(scope = "distribution", name = "delete-folder-ged-ref",
    description = "Add a folder to the Alfresco from the referential project")
public class DeleteFolderAlfrescoReferentielCommand extends OsgiCommandSupport
{
  ...
  protected Object doExecute() throws Exception
  {
    ...
    try
    {
      ...
      else
      {
        ...
        // karaf response if removal is OK
