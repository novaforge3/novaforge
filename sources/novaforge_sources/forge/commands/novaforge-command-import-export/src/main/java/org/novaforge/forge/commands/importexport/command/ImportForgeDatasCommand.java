 ...
 * @author sbenoist
 */
@Command(scope = "forge", name = "importDatas", description = "Import datas into current forge")
public class ImportForgeDatasCommand extends OsgiCommandSupport
{
  ...
  {
    importService.importDatas(importFilePath);
    return null;
  }

  public void setImportService(final ImportService pImportService)
  {
