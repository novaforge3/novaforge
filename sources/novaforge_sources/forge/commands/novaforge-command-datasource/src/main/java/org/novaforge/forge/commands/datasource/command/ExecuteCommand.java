...
/**
 * This class describes a command bean used to execute sql command on specific datasource
 * 
 * @author Guillaume Lamirand
 */
@Command(scope = "ds", name = "exec", description = "Executes a SQL command")
public class ExecuteCommand implements Action
{
	/**
	 * Parameter given to this command, ie "UPDATE TABLE SET id=1"
	 */
	@Argument(index = 0, name = "sql", required = true, description = "SQL command", multiValued = false)
	String										sql;
	/**
