 ...
 */
@Command(scope = "portal", name = "messages-refresh", description = "Refresh portal messages")
public class MessagesRefreshShellCommand extends OsgiCommandSupport
{

	/**
	 * Reference to implementation of {@link PortalMessages}
	 */
