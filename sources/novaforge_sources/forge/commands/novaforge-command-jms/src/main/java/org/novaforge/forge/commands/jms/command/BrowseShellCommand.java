...
public class BrowseShellCommand extends OsgiCommandSupport
{

   @Argument(index = 0, name = "queue", description = "The name of the queue to browse", required = true, multiValued = false)
   ...
   {
      messageService.browseQueue(queue);
      return null;
   }
