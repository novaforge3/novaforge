 ...
 *
 */
@Command(scope = "jms", name = "publish", description="Publish a JMS text message to the sampletopic topic")
public class PublishShellCommand extends OsgiCommandSupport
{  
   ...
   {
      messageService.publish("sampletopic", text);
      return null;
   }
